...
class Install {
	...
	private function do_install() {
		...
		if ( !is_null( $o5 ) ) { $this->update_options_v5( $o, $o5 ); }
		if ( !is_null( $o6 ) ) { $this->update_options_v6( $o, $o6 ); }
		if ( !is_null( $o1 ) ) { $this->update_options_v1( $o, $o1 ); }
	...
	private function update_options_first1( &$o ){
		...
		if ( !isset( $o['hide-in_admin_panel'] ) ) { $o['hide-in_admin_panel'] = 1; }
