        ...
        class WF_Product_Import_Export_CSV {
            ...
            function webtoffee_storefrog_admin_notices() {
                ...
                if (in_array($screen->id, $allowed_screen_ids)) { 
                    ...
                    $content .= '<div class="updated woocommerce-message webtoffee-storefrog-nav-tab"><ul>' . $notice . '</ul><div class="webtoffee-storefrog-banner"><a href="http://www.storefrog.com/" target="_blank"> <img src="'.  plugins_url(basename(plugin_dir_path(WF_ProdImpExpCsv_FILE))) . '/images/storefrog.png"/></a></div></div>';
                    echo $content;
                }
            }
