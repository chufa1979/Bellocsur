<?php
/*
Plugin Name: Eonet Live Search
Plugin URI: https://wordpress.org/plugins/eonet-live-search/
Description: Search dynamically in real time through all your site, including pages, posts, members, products & so on.
Text Domain: eonet-live-search
