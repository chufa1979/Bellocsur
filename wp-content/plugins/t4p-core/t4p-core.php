...
if( ! class_exists( 'T4PCore_Plugin' ) ) {
	class T4PCore_Plugin {
		...
		add_action('after_setup_theme', array(&$this, 'get_theme_prefix'));		
...
register_activation_hook( __FILE__, 't4p_flush_rewrite_rules' );
function t4p_flush_rewrite_rules() {
    t4p_register_post_types();
