		...
		*/
		...
		'modal' => array(
			...
			'desc' => __( 'Add the class name of the modal window you want to open on button click.', 't4p-core' ),
                ...
                'align' => array(
			'type' => 'select',
			'label' => __( 'Button Alignment', 't4p-core' ),
			'desc' => __( 'Choose how to align the button', 't4p-core' ),
			'options' => array(
				'left' => 'Left',
				'center' => 'Center',
				'right' => 'Right',
