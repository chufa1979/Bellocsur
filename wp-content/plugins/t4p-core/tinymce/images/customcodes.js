//////////////////////////////////////////////////////////////////
// Add Theme4Press Button
//////////////////////////////////////////////////////////////////
(function() {  
    tinymce.create('tinymce.plugins.t4pbutton', {
        init : function(ed, url) {  
            t4p_shortcode_url = url;
        },    
        createControl : function(n, cm) {
            switch(n) {
                case 't4pbutton':
                    var c = cm.createSplitButton('t4pbutton', {
                        title : 'Theme4Press Shortcodes',
                        image : t4p_shortcode_url+'/t4pbutton.png'
                    }); 
                    ...
                    c.onRenderMenu.add(function(c, m) {
                        ...
                        m.add({
                            ...
                            icon: 't4p_blog',
                            onclick : function() {
                                tinyMCE.activeEditor.selection.setContent('[blog number_posts="10" cat_slug="" exclude_cats="" title="yes" thumbnail="yes" excerpt="yes" excerpt_words="35" meta_all="yes" meta_author="yes" meta_categories="yes" meta_comments="yes" meta_date="yes" meta_link="yes" paging="yes" scrolling="pagination" blog_grid_columns="3" strip_html="yes" layout="large"][/blog]');
                            }
                        });
                        ...
                        m.add({
                            title : 'Content Boxes',
                            icon: 't4p_content_boxes',
                            onclick : function() {
                                tinyMCE.activeEditor.selection.setContent('[content_boxes layout="icon-with-title, icon-on-top, icon-on-side, icon-boxed" iconcolor="" circlecolor="" circlebordercolor="" backgroundcolor=""]<br />[content_box title="Responsive Design" icon="tablet" image="" link="http://theme4press.com" linktarget="" linktext="Learn More"]alora is fully responsive and can adapt to any screen size. Try resizing your browser window to see the adaptation.[/content_box]<br />[content_box title="Awesome Sliders" icon="thumbs-up" image="" link="http://theme4press.com" linktarget="" linktext="Learn More"]alora includes the awesome Layer Parallax Slider as well as the popular FlexSlider2. Both are super easy to use![/content_box]<br />[content_box title="Unlimited Colors"  icon="magic" image="" link="http://theme4press.com" linktarget="" linktext="Learn More"]We included a backend color picker for unlimited color options. Anything can be changed, including the gradients![/content_box]<br />[content_box last="yes" title="500+ Google Fonts" icon="beaker" image="" link="http://theme4press.com" linktarget="" linktext="Learn More"]alora loves fonts, choose from over 500+ Google Fonts. You can change all headings and body copy with ease![/content_box]<br />[/content_boxes]');
                            }
                        });

                        m.add({
                            title : 'Counters Circle',
                            icon: 't4p_counters_circle',
                            onclick : function() {
                        ...
                        m.add({
                            ...
                            icon: 't4p_full',
                            onclick : function() {
                                tinyMCE.activeEditor.selection.setContent('[fullwidth menu_anchor="" backgroundcolor="" backgroundimage="" backgroundrepeat="no-repeat" backgroundposition="top left" backgroundattachment="scroll" bordersize="1px" bordercolor="" paddingTop="20px" paddingBottom="20px"]...[/fullwidth]');
                            }
                        });
                        ...
                        m.add({
                            ...
                            icon: 't4p_menuanchor',
                            onclick : function() {
                                tinyMCE.activeEditor.selection.setContent('[menu_anchor name=""]');
                            }
                        });                        

                        m.add({
                            title : 'Progress Bar',
                            icon: 't4p_progress_bar',
                            onclick : function() {
                        ...
                        m.add({
                            title : 'Pricing Table',
                            icon: 't4p_pricing_table',
                            onclick : function() {
                                tinyMCE.activeEditor.selection.setContent('[pricing_table type="e.g. 1 or 2" backgroundcolor="" bordercolor="" dividercolor=""][pricing_column title="Standard"][pricing_price currency="$" price="15.55" time="monthly"][/pricing_price][pricing_row]Feature 1[/pricing_row][pricing_footer]<input class="default button medium" type="submit" value="Sign Up"/>[/pricing_footer][/pricing_column][/pricing_table]');
                            }
                        });

                        m.add({
                            title : 'Recent Works',
                            icon: 't4p_recent_works',
                            onclick : function() {
                        ...
                        m.add({
                            title : 'Recent Posts',
                            icon: 't4p_recent_posts',
                            onclick : function() {
                                tinyMCE.activeEditor.selection.setContent('[recent_posts layout="default, thumbnails-on-side, icon-on-side" columns="1-4" number_posts="4" cat_slug="" exclude_cats="" thumbnail="yes" title="yes" meta="yes" excerpt="yes" excerpt_words="15" strip_html="yes"][/recent_posts]');
                            }
                        });
                        ...
                        m.add({
                            ...
                            icon: 't4p_slider',
                            onclick : function() {
                                tinyMCE.activeEditor.selection.setContent('[slider width="100%" height="100%"][slide type="video"][vimeo id="78439312" width="600" height="350"][/slide][slide link="" linktarget="" lightbox="yes or no"]image link here[/slide][/slider]');
                            }
                        });

                        m.add({
                            title : 'Social Links',
                            icon: 't4p_social_links',
                            onclick : function() {
                                tinyMCE.activeEditor.selection.setContent('[social_links colorscheme="" linktarget="" rss="" facebook="" twitter="" dribbble="" google="" linkedin="" blogger="" tumblr="" reddit="" yahoo="" deviantart="" vimeo="" youtube="" pinterest="" digg="" flickr="" forrst="" myspace="" skype="" show_custom="no"]');
                            }
                        });
                        ...
                        m.add({
                            ...
                            icon: 't4p_separator',
                            onclick : function() {
                                tinyMCE.activeEditor.selection.setContent('[section_separator divider_candy="bottom or top or bottom,top" icon="" icon_color="" bordersize="" bordercolor="" backgroundcolor=""]');
                            }
                        });                            
                        ...
                        m.add({
                            ...
                            icon: 't4p_separator',
                            onclick : function() {
                                tinyMCE.activeEditor.selection.setContent('[separator top="40" bottom="" style="none, single, double, dashed, dotted, shadow"]');
                            }
                        });

                        m.add({
                            title : 'Sharing Box',
                            icon: 't4p_sharing_box',
                            onclick : function() {
                                tinyMCE.activeEditor.selection.setContent('[sharing tagline="Share This" title="Title To Share" link="http://google.com" description="A small description of the page" backgroundcolor=""][/sharing]');
                            }
                        });
                        ...
                        m.add({
                            ...
                            icon: 't4p_tagline',
                            onclick : function() {
                                tinyMCE.activeEditor.selection.setContent('[tagline_box backgroundcolor="" shadow="no" border="0px" bordercolor="" highlightposition="right, left, top or bottom" link="http://theme4press.com" linktarget="" buttoncolor="e.g. green, darkgreen, orange, blue, red, pink, darkgray, lightgray or leave blank" button="Purchase Now" title="alora is incredibly responsive, with a refreshingly clean design" description="And it has some awesome features, premium sliders, unlimited colors, advanced theme options and so much more!"][/tagline_box]');
                            }
                        });
...
<td><strong>Tax</strong></td> \
                        ...
                        m.add({
                            ...
                            icon: 't4p_youtube',
                            onclick : function() {
                                tinyMCE.activeEditor.selection.setContent('[youtube id="Enter video ID (eg. RZRyQT1qedE)" width="600" height="350"]');
                            }
                        });
    ...
    tinymce.PluginManager.add('t4pbutton', tinymce.plugins.t4pbutton);  
})();