...
class T4PSC_Imageframe {
    ...
    public function __construct() {
        ...
        add_filter( 't4p_attr_imageframe-shortcode', array( $this, 'attr' ) );
        add_filter( 't4p_attr_imageframe-shortcode-link', array( $this, 'link_attr' ) );
    ...
    function render( $args, $content = '') {
        ...
        $defaults = T4PCore_Plugin::set_shortcode_defaults(
        	array(
				...
				'align' 				=> '',
				'bordercolor' 			=> '',
				'bordersize' 			=> $smof_data['imageframe_border_size'].$evl_options['evl_shortcode_image_frame_border_size'],
				'lightbox' 				=> 'no',				
				'style' 				=> '',
				'style_type'			=> 'none',				
				'stylecolor' 			=> '',
    ...
    function attr() {
        ...
        $attr['class'] = sprintf( 't4p-imageframe imageframe imageframe-%s imageframe-%s', self::$args['style'], $this->imageframe_counter );
