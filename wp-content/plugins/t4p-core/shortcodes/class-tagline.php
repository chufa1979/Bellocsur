...
class T4PSC_Tagline {
    ...
    public function __construct() {
		...
		add_filter( 't4p_attr_tagline-shortcode', array( $this, 'attr' ) );
		add_filter( 't4p_attr_tagline-shortcode-reading-box', array( $this, 'reading_box_attr' ) );
		add_filter( 't4p_attr_tagline-shortcode-button', array( $this, 'button_attr' ) );
    ...
    function render( $args, $content = '') {
        ...
        $defaults = T4PCore_Plugin::set_shortcode_defaults(
			array(
				'class'					=> '',			
				'id'                  	=> '',
				'backgroundcolor'		=> strtolower( $smof_data['tagline_bg'] ).strtolower( $evl_options['evl_shortcode_tagline_bg_color'] ),
				'border' 				=> '0px',
				'bordercolor' 			=> strtolower( $smof_data['tagline_border_color'] ).strtolower( $evl_options['evl_shortcode_tagline_border_color'] ),
				'button' 				=> '',
				'buttoncolor' 			=> 'default',
    ...
    function button_attr() {
        ...
        $attr['class'] = sprintf( 'btn button btn-default t4p-button button-%s button-%s button-%s button-%s%s default', self::$args['buttoncolor'], 
