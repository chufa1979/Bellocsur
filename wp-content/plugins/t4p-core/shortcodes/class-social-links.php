...
class T4PSC_SocialLinks {
    ...
    public function __construct() {
        ...
        add_filter( 't4p_attr_social-links-shortcode', array( $this, 'attr' ) );
        add_filter( 't4p_attr_social-links-shortcode-social-networks', array( $this, 'social_networks_attr' ) );	
        add_filter( 't4p_attr_social-links-shortcode-icon', array( $this, 'icon_attr' ) );	
    ...
    function render( $args, $content = '') {
        ...
        $defaults = T4PCore_Plugin::set_shortcode_defaults(
        	array(
				'class'					=> '',        	
				'id'					=> '',
				'icons_boxed'			=> strtolower( $smof_data['social_links_boxed'] ).strtolower( $evl_options['evl_shortcode_social_icon_boxed'] ),
				'icons_boxed_radius' 	=> strtolower( $smof_data['social_links_boxed_radius'] ).strtolower( $evl_options['evl_shortcode_social_icon_box_radius'] ),
				'icon_colors'			=> strtolower( $smof_data['social_links_icon_color'] ).strtolower( $evl_options['evl_shortcode_social_icon_color'] ),
				'box_colors'			=> strtolower( $smof_data['social_links_box_color'] ).strtolower( $evl_options['evl_shortcode_social_icon_box_color'] ),
				'icon_order'			=> '',
				'linktarget'			=> '_self',
				'show_custom'			=> 'no',
				'tooltip_placement'		=> strtolower( $smof_data['social_links_tooltip_placement'] ).strtolower( $evl_options['evl_shortcode_social_icon_tooltip_position'] ),
		...
		if( self::$args['show_custom'] == 'yes' && $theme_prefix == 'alora_' ) {
		...
		foreach( $social_networks as $network => $link ) {
			...
			$custom = '';
			if( $network == 'custom' ) {
                            if ( $smof_data['custom_icon_image'] ) {
    ...
    function get_social_links_array() {
		...
		if( isset( self::$args['show_custom'] ) && self::$args['show_custom'] && $theme_prefix == 'alora_' ) {
