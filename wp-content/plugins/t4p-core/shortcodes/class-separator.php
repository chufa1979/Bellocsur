...
class T4PSC_Separator {
    ...
    public function __construct() {
        ...
        add_filter( 't4p_attr_separator-shortcode', array( $this, 'attr' ) );
        add_filter( 't4p_attr_separator-shortcode-icon-wrapper', array( $this, 'icon_wrapper_attr' ) );
        add_filter( 't4p_attr_separator-shortcode-icon', array( $this, 'icon_attr' ) );
    ...
    function render( $args, $content = '') {
        ...
        $defaults = T4PCore_Plugin::set_shortcode_defaults(
        	array(
				...
				'bottom_margin'	=> '',
				'icon'			=> '',
				'sep_color'		=> $smof_data['sep_color'].$evl_options['evl_shortcode_separator_color'],
                'style_type'    => 'none',
			   	'top_margin'	=> '',
			   	'width'			=> '',
			   	'bottom'		=> '',	//deprecated
    ...
    function attr() {
		...
		$attr['class'] = sprintf( 't4p-separator' );    
        $attr['style'] = '';
