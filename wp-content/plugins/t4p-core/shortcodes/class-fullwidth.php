...
class T4PSC_FullWidth {
	...
	public function __construct() {
		...
		add_filter( 't4p_attr_fullwidth-shortcode', array( $this, 'attr' ) );
	...
	function render( $args, $content = '') {
		...
		$defaults =	T4PCore_Plugin::set_shortcode_defaults(
			array(
				...
				'backgroundcolor'			=> $smof_data['full_width_bg_color'].$evl_options['evl_shortcode_full_width_bg_color'],
				'backgroundimage' 			=> '',
				'backgroundposition' 		=> 'left top',				
				'backgroundrepeat' 			=> 'no-repeat',
				'bordercolor' 				=> $smof_data['full_width_border_color'].$evl_options['evl_shortcode_full_width_border_color'],
				'bordersize' 				=> $smof_data['full_width_border_size'].$evl_options['evl_shortcode_full_width_border_size'],
				'borderstyle' 				=> 'solid',
				'menu_anchor' 				=> '',
				'paddingbottom' 			=> '20px',
				'paddingtop'				=> '20px',
	...
	function attr() {
		...
		$attr['class'] = 't4p-fullwidth fullwidth-box hentry';
		$attr['style'] = '';
