...
class T4PSC_Alert {
    ...
    public function __construct() {
        ...
        add_filter( 't4p_attr_alert-shortcode', array( $this, 'attr' ) );
        add_filter( 't4p_attr_alert-shortcode-icon', array( $this, 'icon_attr' ) );
        add_filter( 't4p_attr_alert-shortcode-button', array( $this, 'button_attr' ) );
    ...
    function attr() {
        ...
        $attr['class'] = sprintf( 't4p-alert alert %s alert-dismissable alert-%s', self::$args['type'], $this->alert_class );
    ...
    function icon_attr() {
        ...
        $attr['class'] = sprintf( 'fa fa-lg %s', T4PCore_Plugin::font_awesome_name_handler( self::$args['icon'] ) );
