...
class T4PSC_FontAwesome {
	...
	public function __construct() {
		...
		add_filter( 't4p_attr_fontawesome-shortcode', array( $this, 'attr' ) );
	...
	function render( $args, $content = '') {
		...
		$html = sprintf( '<i %s>%s</i>', T4PCore_Plugin::attributes( 'fontawesome-shortcode' ), do_shortcode( $content ) );
