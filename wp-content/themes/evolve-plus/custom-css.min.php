...
$evolve_min_custom_width_px             = $evolve_custom_width_px + 20;
...
$evolve_top_menu_font                   = evolve_get_option( 'evl_top_menu_font' );
...
$evolve_min_custom_width_100_px         = $evolve_custom_width_px - 60;
$evolve_min_custom_width_100_px_plus    = $evolve_custom_width_px - 30;
...
$evolve_min_custom_width_100_px_padding = $evolve_min_custom_width_100_px + (2*$evolve_hundredp_padding);
$evolve_custom_left_100                 = $evolve_min_custom_width_100_px_plus/2;
...
$evolve_single_hundredp_padding       = get_post_meta($post_id, 'evolve_hundredp_padding', true);

if(!empty($evolve_single_hundredp_padding)) {
$evolve_hundredp_padding              = $evolve_single_hundredp_padding;
}
...
$evolve_shortcode_counter_boxes_color                = evolve_get_option( 'evl_shortcode_counter_boxes_color', '#000000' );
$evolve_shortcode_counter_boxes_shadow               = evolve_get_option( 'evl_shortcode_counter_boxes_shadow', '0' );
$evolve_shortcode_flip_boxes_heading_color_frontside = evolve_get_option( 'evl_shortcode_flip_boxes_heading_color_frontside', '#333333' );
$evolve_shortcode_flip_heading_color_backside        = evolve_get_option( 'evl_shortcode_flip_heading_color_backside', '#eeeded' );
$evolve_shortcode_pricing_style_1_heading_color      = evolve_get_option( 'evl_shortcode_pricing_style_1_heading_color', '#ffffff' );
$evolve_shortcode_pricing_style_2_heading_color      = evolve_get_option( 'evl_shortcode_pricing_style_2_heading_color', '#333333' );
$evolve_shortcode_pricing_box_color                  = evolve_get_option( 'evl_shortcode_pricing_box_color', '#0bb697' );
$evolve_shortcode_pricing_box_border_color           = evolve_get_option( 'evl_shortcode_pricing_box_border_color', '#dcdcdc' );
$evolve_shortcode_accordion_inactive_box_color       = evolve_get_option( 'evl_shortcode_accordion_inactive_box_color', '#f2f2f2' );
$evolve_shortcode_title_sep_color                    = evolve_get_option( 'evl_shortcode_title_sep_color', '#f0f0f0' );
$evolve_shortcode_person_border_size                 = evolve_get_option( 'evl_shortcode_person_border_size', '0px' );
$evolve_shortcode_person_border_color                = evolve_get_option( 'evl_shortcode_person_border_color', '#f6f6f6' );
$evolve_shortcode_tabs_bg_color                      = evolve_get_option( 'evl_shortcode_tabs_bg_color', '#0bb697' );

// Custom Fonts
$evolve_custom_font_woff = evolve_get_option( 'evl_custom_font_woff' );
$evolve_custom_font_ttf  = evolve_get_option( 'evl_custom_font_ttf' );
$evolve_custom_font_svg  = evolve_get_option( 'evl_custom_font_svg' );
$evolve_custom_font_eot  = evolve_get_option( 'evl_custom_font_eot' );

// Menu hover effect color
$evolve_top_menu_hover_color 	  = evolve_get_option('evl_top_menu_hover_color', '#0bb697');
...
$evolve_menu_submenu_font_icon    = evolve_get_option('evl_menu_submenu_font_icon', 'regular');
...
$evolve_css_data .= '.t4p-counters-box .t4p-counter-box .counter-box-container { text-shadow: 0 1px 0 rgba(0, 0, 0, 0.4); -webkit-box-shadow: 0 1px 60px rgba(0, 0, 0, 0.2) inset; -moz-box-shadow: 0 1px 60px rgba(0, 0, 0, 0.2) inset; -box-shadow: 0 1px 60px rgba(0, 0, 0, 0.2) inset; box-shadow: 0 1px 60px rgba(0, 0, 0, 0.2) inset; }';
    }
...
$evolve_css_data .= '.sticky-header .nav { float: left; margin-left: 25px; } .content-boxes .col { background-color: ' . $evolve_shortcode_content_box_color . '; } .t4p-counters-box .t4p-counter-box .counter-box-container { color: ' . $evolve_shortcode_counter_boxes_color . ' ; } .t4p-counters-box .t4p-counter-box .counter-box-border { border-color: ' . $evolve_shortcode_counter_boxes_color . '; border: 1px solid; } .t4p-flip-box .flip-box-heading { color: ' . $evolve_shortcode_flip_boxes_heading_color_frontside . ' ; } .t4p-flip-box .flip-box-heading-back { color: ' . $evolve_shortcode_flip_heading_color_backside . ' ; } .sep-boxed-pricing .panel-heading h3 { color: ' . $evolve_shortcode_pricing_style_1_heading_color . ' ; } .full-boxed-pricing.t4p-pricing-table .panel-heading h3 { color: ' . $evolve_shortcode_pricing_style_2_heading_color . ' ; } .sep-boxed-pricing .panel-heading, .sep-boxed-pricing .pricing-row { background-color: ' . $evolve_shortcode_pricing_box_color . ' !important; } .sep-boxed-pricing .panel-container, .full-boxed-pricing { border-color: ' . $evolve_shortcode_pricing_box_border_color . ' ; } .t4p-accordian .panel-heading { background-color: ' . $evolve_shortcode_accordion_inactive_box_color . '; } .t4p-title .title-sep { border-color: ' . $evolve_shortcode_title_sep_color . '; } .person-img, .person-imgage-container img { border: ' . $evolve_shortcode_person_border_size . ' solid ' . $evolve_shortcode_person_border_color . '; } ul.nav-menu a { text-transform: ' . $evolve_menu_text_transform . ' } ul.nav-menu li a:active, ul.nav-menu li:active > a, ul.nav-menu li a:focus, ul.nav-menu li:focus > a, ul.nav-menu li a:hover, ul.nav-menu li:hover> a, ul.nav-menu li:hover, ul.nav-menu li a:hover span, ul.nav-menu li:hover> a span, ul.nav-menu li:hover> .sf-with-ul::after { color: ' . $evolve_top_menu_hover_font_color . '; }';
if ($evolve_menu_submenu_font_icon == 'plus') {
...
if ($menu_effect == 'smooth') {
    $evolve_css_data .= '@media only screen and (min-width: 768px) { ul.nav-menu{ margin:0; padding-bottom: 0; } ul.nav-menu li { -webkit-transition: all .1s ease-in; -moz-transition: all .1s ease-in; -o-transition: all .1s ease-in; -ms-transition: all .1s ease-in; transition: all .1s ease-in; } ul.nav-menu li span:hover, .sticky-header .menu-item a:hover, .sc_menu a:hover, .sc_menu a.tipsytext:hover { color: ' . $evolve_top_menu_hover_font_color . ' ; } ul.nav-menu .sf-with-ul:hover::after { color: ' . $evolve_top_menu_hover_font_color . '; } ul.nav-menu li:hover { background: ' . $evolve_top_menu_hover_color . ' none repeat scroll 0 0; } }';
} elseif ($menu_effect == 'rollover') {
...
if ( is_home() || is_front_page() ) {
    if ($evolve_width_px != "custom" && ( $evolve_frontpage_width_layout == "fixed" ) && !is_page_template('100-width.php')) {
        $evolve_css_data .= '@media (min-width: ' . $evolve_min_width_px . 'px) { .container, #wrapper { width: ' . $evolve_width_px . 'px; } .wooslider { max-width: ' . $evolve_width_px . 'px; } }';
    } elseif($evolve_width_px != "custom" ) {
        $evolve_css_data .= '.wooslider { max-width: ' . $evolve_width_px . 'px; } @media (min-width: ' . $evolve_min_width_px . 'px) { .container { width: ' . $evolve_width_px . 'px; } .menu-back .container:first-child { width: 100%; padding-left: 0px; padding-right: 0px; } }';
    } elseif ($evolve_width_px == "custom" && ( $evolve_frontpage_width_layout == "fixed" ) && !is_page_template('100-width.php')) {
        $evolve_css_data .= '@media (min-width: ' . $evolve_min_custom_width_px . 'px) { .container, #wrapper { width: ' . $evolve_custom_width_px . 'px; } .wooslider { max-width: ' . $evolve_custom_width_px . 'px; } }';
    } elseif($evolve_width_px == "custom" ) {
        $evolve_css_data .= '.wooslider { max-width: ' . $evolve_custom_width_px . 'px; } @media (min-width: ' . $evolve_min_custom_width_px . 'px) { .container { width: ' . $evolve_custom_width_px . 'px; } .menu-back .container:first-child { width: 100%; padding-left: 0px; padding-right: 0px; } }';
    }
} elseif ($evolve_width_px != "custom" && ( $evolve_width_layout == "fixed" ) && !is_page_template('100-width.php')) {
$evolve_css_data .= '@media (min-width: ' . $evolve_min_width_px . 'px) { .container, #wrapper { width: ' . $evolve_width_px . 'px; } .wooslider { max-width: ' . $evolve_width_px . 'px; } }';
} elseif($evolve_width_px != "custom" ) {
$evolve_css_data .= '.wooslider { max-width: ' . $evolve_width_px . 'px; } @media (min-width: ' . $evolve_min_width_px . 'px) { .container { width: ' . $evolve_width_px . 'px; } .menu-back .container:first-child { width: 100%; padding-left: 0px; padding-right: 0px; } }';
} elseif ($evolve_width_px == "custom" && ( $evolve_width_layout == "fixed" ) && !is_page_template('100-width.php')) {
...
if ($evolve_width_px != "custom") {
    $evolve_max_width_px = $evolve_min_width_px-1 ;
$evolve_css_data .= '@media only screen and (max-width: ' . $evolve_max_width_px . 'px) { body #header.sticky-header { margin: 0px ; left: 0px; } }';

} else {
    $evolve_max_custom_width_px = $evolve_min_custom_width_px-1 ;
$evolve_css_data .= '@media only screen and (max-width: ' . $evolve_max_custom_width_px . 'px) { body #header.sticky-header { margin: 0px ; left: 0px; } }';
}    

if (is_page_template('100-width.php') && $evolve_width_px != "custom" ) {
$evolve_css_data .= '.content .container { width: 100%; padding-left: ' . $evolve_hundredp_padding . '; padding-right: ' . $evolve_hundredp_padding . '; } ul.breadcrumbs { margin-bottom: 5px; } @media (max-width: ' . $evolve_min_width_px . 'px) { .container-100-width { width: auto; padding-left: 15px; padding-right: 15px; } } @media (min-width: ' . $evolve_min_width_px . 'px) { .container-100-width { width: ' . $evolve_min_width_100_px_plus . 'px; padding-left: 15px; padding-right: 15px; margin-left: -' . $evolve_left_100 . 'px; left: 50%; position: relative; } } @media (min-width: ' . $evolve_min_width_px . 'px) { .content .container .t4p-fullwidth .t4p-row, .t4p_frontpage_blog.content .container { width: ' . $evolve_min_width_100_px . 'px; margin-left: auto; margin-right: auto; } } .content .container .t4p-fullwidth { // margin-left: -' . $evolve_hundredp_padding . '; // margin-right: -' . $evolve_hundredp_padding . '; padding-left: ' . $evolve_hundredp_padding . ' !important; padding-right: ' . $evolve_hundredp_padding . ' !important; }';	
}
        
if (is_page_template('100-width.php') && $evolve_width_px == "custom" ) {
$evolve_css_data .= '.content .container { width: 100%; padding-left: ' . $evolve_hundredp_padding . '; padding-right: ' . $evolve_hundredp_padding . '; } ul.breadcrumbs { margin-bottom: 5px; } @media (max-width: ' . $evolve_min_custom_width_px . 'px) { .container-100-width { width: auto; padding-left: 15px; padding-right: 15px; } } @media (min-width: ' . $evolve_min_custom_width_px . 'px) { .container-100-width { width: ' . $evolve_min_custom_width_100_px_plus . 'px; padding-left: 15px; padding-right: 15px; margin-left: -' . $evolve_custom_left_100 . 'px; left: 50%; position: relative; } } @media (min-width: ' . $evolve_min_custom_width_px . 'px) { .content .container .t4p-fullwidth .t4p-row, .t4p_frontpage_blog.content .container { width: ' . $evolve_min_custom_width_100_px . 'px; margin-left: auto; margin-right: auto; } } .content .container .t4p-fullwidth { // margin-left: -' . $evolve_hundredp_padding . '; // margin-right: -' . $evolve_hundredp_padding . '; padding-left: ' . $evolve_hundredp_padding . ' !important; padding-right: ' . $evolve_hundredp_padding . ' !important; }';	
}
...
$evolve_css_data .= '.animated { visibility: hidden; } '; } else { $evolve_css_data .= ' .animated { visibility: visible; }';
}
...
$evolve_css_data .= 'body #header.sticky-header img#logo-image { display: none; }';
    }

if ((isset($evolve_custom_font_woff['url']) != "") && ( $evolve_custom_font_svg['url'] != "") && ($evolve_custom_font_eot['url'] != "" ) && ($evolve_custom_font_ttf['url'] != "" )) {
$evolve_css_data .= '@font-face { font-family: "CustomFont"; src: url("' . $evolve_custom_font_eot['url'] . '"); src: url("' . $evolve_custom_font_eot['url'] . '?#iefix") format("eot"), url("' . $evolve_custom_font_woff['url'] . '") format("woff"), url("' . $evolve_custom_font_ttf['url'] . '") format("truetype"), url("' . $evolve_custom_font_svg['url'] . '#CustomFont") format("svg"); font-weight: 400; font-style: normal; } .entry-title, .entry-title a { font-family: "CustomFont"; } ul.nav-menu a, #tagline, #logo { font-family: "CustomFont"; } body, input, textarea { font-family: "CustomFont" ; } body .t4p-person .person-desc .person-author .person-author-wrapper { font-family: "CustomFont"; } .person-author-wrapper .person-name { font-family: "CustomFont" ; } .product-title, .product-title a { font-family: "CustomFont"; } #sticky-logo { font-family: "CustomFont"; }';
    ...
    //Post title font
    $evolve_css_data .= evolve_print_fonts('evl_post_font', '.entry-title, .entry-title a, .page-title, .entry-content .t4p-blog-shortcode  .entry-title a', '', '', '');

    //Content font
    $evolve_css_data .= evolve_print_fonts('evl_content_font', '.entry-content, .entry-content p', $additional_css = 'line-height:1.5em', $additional_color_css_class = 'body', $imp = '');
    ...
    $evolve_css_data .= evolve_print_homepagebuilder_fonts('evl_content_boxes_title_alignment', 'h2.content_box_section_title', '', '', '!important');

    //Testimonials Title Section
    $evolve_css_data .= evolve_print_homepagebuilder_fonts('evl_testimonials_title_alignment', 'h2.testimonials_section_title', '', '', '!important');

    //Counter Circle Title Section
    $evolve_css_data .= evolve_print_homepagebuilder_fonts('evl_counter_circle_title_alignment', 'h2.counter_circle_section_title', '', '', '!important');

    //Google Map Title Section
    $evolve_css_data .= evolve_print_homepagebuilder_fonts('evl_googlemap_title_alignment', 'h2.googlemap_section_title', '', '', '!important');

    // Woocommerce Product Title Section
    include_once( ABSPATH . 'wp-admin/includes/plugin.php' );
    if ( is_plugin_active('woocommerce/woocommerce.php') ) :
        $evolve_css_data .= evolve_print_fonts('evl_woo_product_title_alignment', 'h2.woo_product_section_title', '', '', '!important');
    endif;
    
    //Custom Content Title Section
    $evolve_css_data .= evolve_print_homepagebuilder_fonts('evl_custom_content_title_alignment', 'h2.custom_content_section_title', '', '', '!important');

    //Blog Title Section
    $evolve_css_data .= evolve_print_homepagebuilder_fonts('evl_blog_section_title_alignment', 'h2.fp_blog_section_title', '', '', '!important');
...
if ($evolve_custom_background == "1" && !is_page_template('100-width.php')) {
...
} elseif ($menu_effect == 'smooth' && ($evolve_header_type == 'none' || $evolve_header_type == 'h5')) {
    $evolve_css_data .= 'ul.nav-menu li:hover, ul.nav-menu li.current_page_parent, ul.nav-menu li.current_page_ancestor { text-decoration: none; background: ' . $evolve_top_menu_hover_color . ' none repeat scroll 0 0; -webkit-box-shadow: 0 1px 0 rgba(255, 255, 255, 0.3) inset, 0 0 2px rgba(255, 255, 255, 0.3) inset, 0 0 10px rgba(0, 0, 0, 0.2) inset, 0 1px 2px rgba(0, 0, 0, 0.1); -moz-box-shadow: 0 1px 0 rgba(255, 255, 255, 0.3) inset, 0 0 2px rgba(255, 255, 255, 0.3) inset, 0 0 10px rgba(0, 0, 0, 0.2) inset, 0 1px 2px rgba(0, 0, 0, 0.1); -box-shadow: 0 1px 0 rgba(255, 255, 255, 0.3) inset, 0 0 2px rgba(255, 255, 255, 0.3) inset, 0 0 10px rgba(0, 0, 0, 0.2) inset, 0 1px 2px rgba(0, 0, 0, 0.1); box-shadow: 0 1px 0 rgba(255, 255, 255, 0.3) inset, 0 0 2px rgba(255, 255, 255, 0.3) inset, 0 0 10px rgba(0, 0, 0, 0.2) inset, 0 1px 2px rgba(0, 0, 0, 0.1); }';
}

$evolve_css_data .= 'ul.nav-menu li.current-menu-item > a, ul.nav-menu li.current-menu-ancestor > a, ul.nav-menu li.current-menu-ancestor > a span, ul.nav-menu li.current-menu-item > a span, ul.nav-menu li.current-menu-item > .sf-with-ul::after, ul.nav-menu li.current-menu-ancestor > .sf-with-ul::after, ul.nav-menu li.current-menu-item > a.sf-with-ul::after, .sticky-header ul.nav-menu li.current-menu-item > a { color: ' . $evolve_top_menu_hover_font_color . ' ; }';
...
$Separator = evolve_get_option('evl-shortcode-subsec-shortcodes-separator-tab', '#f0f0f0');
$page_title_bg_opt = evolve_get_option('page_title_bg');

$evolve_css_data .= '.page-title-container { border-color: ' . $Separator . '; }';

$page_title_bar_bg = get_post_meta($post_id, 'evolve_page_title_bar_bg', true);

if (isset($page_title_bar_bg)):
$evolve_css_data .= '.page-title-container { background-image: url(' . $page_title_bar_bg . '); }';
elseif (isset($page_title_bg_opt)):
$evolve_css_data .= '.page-title-container { background-image: url(' . $page_title_bg_opt . '); }';
    endif;
...
$evolve_css_data .= '@media only screen and (-webkit-min-device-pixel-ratio: 1.3), only screen and (-o-min-device-pixel-ratio: 13/10), only screen and (min-resolution: 120dpi) { .header-logo-container .normal_logo, .sticky-header .normal_logo { display: none; } .header-logo-container .retina_logo, .sticky-header .retina_logo { display: inline-block; } }';
endif;
...
$evolve_content_boxes_padding = evolve_get_option('evl_content_boxes_padding', '');
if($evolve_content_boxes_padding != ''):
$evolve_css_data .= '@media (min-width: 992px) { .home-content-boxes .col-md-3.content-box { padding-top: '.$evolve_content_boxes_padding['padding-top'].'; padding-right: '.$evolve_content_boxes_padding['padding-right'].'; padding-bottom: '.$evolve_content_boxes_padding['padding-bottom'].'; padding-left: '.$evolve_content_boxes_padding['padding-left'].'; } }';

endif;

/* Add Mega Menu Custom CSS */

$evolve_megamenu_title_size = evolve_get_option('evl_megamenu_title_size', '15px');
$evolve_menu_font = evolve_get_option('evl_menu_font');
$evolve_widget_content_font = evolve_get_option('evl_widget_content_font');

if ($evolve_width_px != "custom") {
    $evolve_width_col_span_1 = $evolve_width_px / 4;
    $evolve_width_col_span_2 = $evolve_width_col_span_1 * 2;
    $evolve_width_col_span_3 = $evolve_width_col_span_1 * 3;
    
$evolve_css_data .= '@media (min-width: ' . $evolve_min_width_px . 'px) { #wrapper .t4p-megamenu-wrapper.col-span-1 { width: ' . $evolve_width_col_span_1 . 'px; } #wrapper .t4p-megamenu-wrapper.col-span-2 { width: ' . $evolve_width_col_span_2 . 'px; } #wrapper .t4p-megamenu-wrapper.col-span-3 { width: ' . $evolve_width_col_span_3 . 'px; } #wrapper .t4p-megamenu-wrapper { width: ' . $evolve_width_px . 'px; } }';

} else {
    
$evolve_width_col_span_1 = $evolve_custom_width_px / 4;
$evolve_width_col_span_2 = $evolve_width_col_span_1 * 2;
$evolve_width_col_span_3 = $evolve_width_col_span_1 * 3;
    
$evolve_css_data .= '@media (min-width: ' . $evolve_min_custom_width_px . 'px) { #wrapper .t4p-megamenu-wrapper.col-span-1 { width: ' . $evolve_width_col_span_1 . 'px; } #wrapper .t4p-megamenu-wrapper.col-span-2 { width: ' . $evolve_width_col_span_2 . 'px; } #wrapper .t4p-megamenu-wrapper.col-span-3 { width: ' . $evolve_width_col_span_3 . 'px; } #wrapper .t4p-megamenu-wrapper { width: ' . $evolve_custom_width_px . 'px; } }';
}

if(evolve_get_option('evl_disable_megamenu', '0') == '0') {
$evolve_css_data .= '#wrapper .t4p-megamenu-wrapper .t4p-megamenu-title { font-family: '.$evolve_menu_font['font-family'].'; font-size: '.$evolve_megamenu_title_size.'; color: '.$evolve_menu_font['color'].'; text-transform: ' . $evolve_menu_text_transform . '; } #wrapper .t4p-megamenu-wrapper ul li .t4p-megamenu-title:hover, #wrapper .t4p-megamenu-wrapper ul li:hover > .t4p-megamenu-title { color: ' . $evolve_top_menu_hover_font_color . ' ; } #wrapper .t4p-megamenu-wrapper .t4p-megamenu-bullet, .t4p-megamenu-bullet { border-left: 3px solid '.$evolve_menu_font['color'].'; } ul.nav-menu > li { float: left; } ul.nav-menu > li.t4p-dropdown-menu { position: relative; } ul.nav-menu > li.t4p-dropdown-menu li { position: relative; width: 100%; } ul.nav-menu li.t4p-dropdown-menu li:hover ul, ul.nav-menu li.t4p-dropdown-menu li.nav-hover ul, ul.nav-menu li.t4p-dropdown-menu li li:hover ul, ul.nav-menu li.t4p-dropdown-menu li li.nav-hover ul, ul.nav-menu li.t4p-dropdown-menu li li li:hover ul, ul.nav-menu li.t4p-dropdown-menu li li li.nav-hover ul { left: 14em; } ul.nav-menu li.t4p-dropdown-menu ul { left: 0px; width: 14em !important; } ul.nav-menu .t4p-megamenu-menu .widget-content a { color: '.$evolve_widget_content_font['color'].' ; } ul.nav-menu .t4p-megamenu-menu li .widget-content ul, ul.nav-menu .t4p-megamenu-menu li:hover .widget-content ul { background: transparent; } .center-menu ul.nav-menu li { display: block; } #wrapper .t4p-megamenu-wrapper .t4p-megamenu-submenu { border-right-color: #' . evolve_hexDarker($evolve_menu_back_color, 8) . '; } .t4p-megamenu-wrapper.col-span-1, .t4p-megamenu-wrapper.col-span-2, .t4p-megamenu-wrapper.col-span-3 { margin-left: -' . $evolve_menu_padding . '; } ul.nav-menu li li:hover .t4p-megamenu-title, ul.nav-menu li li:hover .t4p-megamenu-title a, ul.nav-menu li li.current-menu-item .t4p-megamenu-title, ul.nav-menu li li.current-menu-item .t4p-megamenu-title a, ul.nav-menu li li.current-menu-ancestor .t4p-megamenu-title, ul.nav-menu li li.current-menu-ancestor .t4p-megamenu-title a { color: ' . $evolve_top_menu_hover_font_color . ' !important; }';

if ($menu_effect == 'rollover') {
    $evolve_css_data .= '@media only screen and (min-width: 768px) { .link-effect a:hover span, .link-effect a:focus span{ -webkit-transform: translateY(0); -moz-transform: translateY(0); transform: translateY(0); } }';
}
    
} else {
    
$evolve_css_data .= 'ul.nav-menu li { float: left; position: relative; } ul.nav-menu li li:hover ul, ul.nav-menu li li.nav-hover ul, ul.nav-menu li li li:hover ul, ul.nav-menu li li li.nav-hover ul, ul.nav-menu li li li li:hover ul, ul.nav-menu li li li li.nav-hover ul { left: 14em; } ul.nav-menu ul { width: 14em !important; } ul.nav-menu ul li { width: 100%; } .center-menu ul.nav-menu li { display: inline-block; } ul.nav-menu, ul.nav-menu * { left: 0; }';
}

/* Bootstrap slider style */
$evolve_bootstrap_slide_title_font_rgba = 'rgba(0, 0, 0, .7)';
...
$evolve_bootstrap_slide_subtitle_font_rgba = 'rgba(0, 0, 0, .7)';
...
if ($evolve_bootstrap_layout == "bootstrap_right") {
$evolve_css_data .= '#bootstrap-slider .layout-right { left: 50%; right: 0; margin-right: 60px; } #bootstrap-slider .carousel-caption { bottom: 12%; } #bootstrap-slider .carousel-control { left: 60px; bottom: 6%; } #bootstrap-slider .right.carousel-control { left: 100px; } @media only screen and (max-width: 992px) { #bootstrap-slider .carousel-caption h2, #bootstrap-slider .carousel-caption p { padding: 10px 25px; } } @media only screen and (max-width: 768px) { #bootstrap-slider .carousel-caption { bottom: 0; } #bootstrap-slider .layout-right { left: 5%; right: 5%; margin-right: 0px; } #bootstrap-slider .carousel-control { bottom: 9%; left: 35px; } #bootstrap-slider .right.carousel-control { left: 65px; } } @media only screen and (max-width: 540px) { #bootstrap-slider .carousel-caption { bottom: 5%; } #bootstrap-slider .layout-right { left: 5%; right: 5%; margin-right: 0px; } #bootstrap-slider .carousel-control { bottom: 7%; left: 20px; } #bootstrap-slider .right.carousel-control { left: 50px; } }';
...
$evolve_css_data .= '#bootstrap-slider .layout-left { left: 0; right: 50%; margin-left: 60px; } #bootstrap-slider .carousel-caption { bottom: 12%; } #bootstrap-slider .carousel-control { left: 60px; bottom: 6%; } #bootstrap-slider .right.carousel-control { left: 100px; } @media only screen and (max-width: 992px) { #bootstrap-slider .carousel-caption h2, #bootstrap-slider .carousel-caption p { padding: 10px 25px; } } @media only screen and (max-width: 768px) { #bootstrap-slider .carousel-caption { bottom: 0; } #bootstrap-slider .layout-left { left: 5%; right: 5%; margin-left: 0px; } #bootstrap-slider .carousel-control { bottom: 9%; left: 40px; } #bootstrap-slider .right.carousel-control { left: 80px; } .content-box p, .entry-content { font-size: 14px; line-height: 1.5; } .content-box p { margin-top: 5px; } .home-content-boxes .cntbox_btn{ top: -20px; } } @media only screen and (max-width: 640px) { #bootstrap-slider .carousel-caption { bottom: 5%; } #bootstrap-slider .layout-left { left: 5%; right: 5%; margin-left: 0px; } #bootstrap-slider .carousel-control { bottom: 7%; } #bootstrap-slider .carousel-control { bottom: 9%; left: 20px; } #bootstrap-slider .right.carousel-control { left: 50px; } }';
}

/* Add page titlebar background style */

$evolve_pagetitlebar_layout = evolve_get_option( 'evl_pagetitlebar_layout', '0');
$evolve_pagetitlebar_background_color = evolve_get_option( 'evl_pagetitlebar_background_color', '#f9f9f9');
$evolve_pagetitlebar_background = evolve_get_option( 'evl_pagetitlebar_background');
$evolve_pagetitlebar_background_retina = evolve_get_option( 'evl_pagetitlebar_background_retina');
$evolve_pagetitlebar_background_full = evolve_get_option( 'evl_pagetitlebar_background_full', '0');
$evolve_pagetitlebar_background_parallax = evolve_get_option( 'evl_pagetitlebar_background_parallax', '0');
$evolve_pagetitlebar_padding = evolve_get_option( 'evl_pagetitlebar_padding', '25');
$evolve_page_title_bar_bg = get_post_meta($post_id, 'evolve_page_title_bar_bg', true);
$evolve_page_title_bar_bg_src = wp_get_attachment_image_src( $evolve_page_title_bar_bg, 'full' );
$evolve_page_title_bar_bg_retina = get_post_meta($post_id, 'evolve_page_title_bar_bg_retina', true);
$evolve_page_title_bar_bg_retina_src = wp_get_attachment_image_src( $evolve_page_title_bar_bg_retina, 'full' );
$evolve_page_title_bar_bg_color = get_post_meta($post_id, 'evolve_page_title_bar_bg_color', true);
$evolve_page_title_bar_full_bg = get_post_meta($post_id, 'evolve_page_title_bar_full_bg', true);
$evolve_page_title_bar_parallax_bg = get_post_meta($post_id, 'evolve_page_title_bar_parallax_bg', true);

if ( empty( $evolve_page_title_bar_full_bg ) ) {
    $evolve_page_title_bar_full_bg = 'default';
}
if ( empty( $evolve_page_title_bar_parallax_bg ) ) {
    $evolve_page_title_bar_parallax_bg = 'default';
}

if($evolve_pagetitlebar_layout == '1'):
$evolve_css_data .= '.page-title-container { border: none; height: auto; } .home .entry-title, .entry-title a, .archive .entry-title, .search .entry-title, .page-template-blog-page-php .entry-title { font-size: 100%; line-height: 100%; margin-bottom: 0; }';
endif;

if($evolve_page_title_bar_bg_color != ""):
$evolve_css_data .= '.page-title-container { background-color: '.$evolve_page_title_bar_bg_color.'; }';

elseif($evolve_pagetitlebar_background_color != ""):
$evolve_css_data .= '.page-title-container { background-color: '.$evolve_pagetitlebar_background_color.'; }';
endif;

if($evolve_page_title_bar_bg != ""):
$evolve_css_data .= '.page-title-container { background-image: url("'.$evolve_page_title_bar_bg_src['0'].'"); }';

elseif($evolve_pagetitlebar_background != ""):
$evolve_css_data .= '.page-title-container { background-image: url("'.$evolve_pagetitlebar_background.'"); }';
endif;

if($evolve_page_title_bar_bg_retina != ""):
$evolve_css_data .= '@media only screen and (-webkit-min-device-pixel-ratio: 1.3), only screen and (-o-min-device-pixel-ratio: 13/10), only screen and (min-resolution: 120dpi) { .page-title-container { background-image: url("'.$evolve_page_title_bar_bg_retina_src['0'].'"); } }';

elseif($evolve_pagetitlebar_background_retina != ""):
$evolve_css_data .= '@media only screen and (-webkit-min-device-pixel-ratio: 1.3), only screen and (-o-min-device-pixel-ratio: 13/10), only screen and (min-resolution: 120dpi) { .page-title-container { background-image: url("'.$evolve_pagetitlebar_background_retina.'"); } }';
endif;

if ( is_home() || is_front_page() ) {
    if($evolve_page_title_bar_full_bg == 'yes' || $evolve_frontpage_width_layout == 'fluid' || is_page_template('100-width.php')) {
        $evolve_css_data .= '.page-title-container { background-attachment: scroll; background-position: center center; -webkit-background-size: cover; -moz-background-size: cover; -o-background-size: cover; background-size: cover; }';
    } elseif(($evolve_pagetitlebar_background_full == '1' && $evolve_page_title_bar_full_bg == 'default') || $evolve_frontpage_width_layout == 'fluid' || is_page_template('100-width.php')) {
        $evolve_css_data .= '.page-title-container { background-attachment: scroll; background-position: center center; -webkit-background-size: cover; -moz-background-size: cover; -o-background-size: cover; background-size: cover; }';
    }
} elseif($evolve_page_title_bar_full_bg == 'yes' || $evolve_width_layout == 'fluid' || is_page_template('100-width.php')) {
$evolve_css_data .= '.page-title-container { background-attachment: scroll; background-position: center center; -webkit-background-size: cover; -moz-background-size: cover; -o-background-size: cover; background-size: cover; }';

} elseif(($evolve_pagetitlebar_background_full == '1' && $evolve_page_title_bar_full_bg == 'default') || $evolve_width_layout == 'fluid' || is_page_template('100-width.php')) {
$evolve_css_data .= '.page-title-container { background-attachment: scroll; background-position: center center; -webkit-background-size: cover; -moz-background-size: cover; -o-background-size: cover; background-size: cover; }';
}

if($evolve_page_title_bar_parallax_bg == 'yes'):
$evolve_css_data .= '.page-title-container { background-attachment: fixed; background-position: top center; }';

elseif($evolve_pagetitlebar_background_parallax == '1' && $evolve_page_title_bar_parallax_bg == 'default'):
$evolve_css_data .= '.page-title-container { background-attachment: fixed; background-position: top center; }';
endif;

if($evolve_pagetitlebar_padding != ''):
$evolve_css_data .= '.page-title-container { padding: '.$evolve_pagetitlebar_padding.'px 0px; }';
endif;

/* UberMenu Plugin Support Style */

$evolve_ubermenu = evolve_get_option('evl_ubermenu');
if($evolve_ubermenu == '1') {
$evolve_css_data .= '.nacked-menu { padding: 0 ; } .sticky-menu .ubermenu .sub-menu { display: none; } @media only screen and (min-width: 768px) { .link-effect a:hover span, .link-effect a:focus span{ -webkit-transform: translateY(-100%); -moz-transform: translateY(-100%); transform: translateY(-100%); } body #header.sticky-header { margin-left: 0; } }'; 
}
...
if (is_plugin_active('ubermenu/ubermenu.php')) {
    ...
    $breakpoint = get_option('ubermenu_general');
    if (isset($breakpoint['responsive_breakpoint']) && $breakpoint['responsive_breakpoint'] != ''):
        $breakpoint_expand = ($breakpoint['responsive_breakpoint'] + '1');
        $breakpoint_actual = $breakpoint['responsive_breakpoint'];
    else:
        $breakpoint_expand = 959;
        $breakpoint_actual = 958;
    endif;

    if ($evolve_ubermenu == '1') {
$evolve_css_data .= '@media (min-width: ' . $breakpoint_expand . 'px) { .ubermenu-responsive-toggle { display: none ; } } @media (max-width: ' . $breakpoint_actual . 'px) { body #header.sticky-header.sticky { display: none ; } .nav-holder .ubermenu-nav ul { display: block; } .ubermenu li.menu-item-language { float: none; } .ubermenu li.menu-item-language ul.sub-menu { display: none; } .ubermenu li.menu-item-language ul.sub-menu { width: 100%; right: 0px; } .ubermenu li.menu-item-language:hover ul.sub-menu { display: block; } }';
    } else {
$evolve_css_data .= '.ubermenu-responsive-toggle { display: block ; }';
    }

    if ($evolve_ubermenu == '1' && $ubermenu_primary == 'primary-menu') {
$evolve_css_data .= '.ubersearch { display: none ; }';
    }

    if ($evolve_ubermenu == '1' && $ubermenu_sticky == 'sticky_navigation') {
$evolve_css_data .= '.stickyubersearch { display: none ; } body #header.sticky-header .nav a { padding-bottom: 20px; }';
    } else {
$evolve_css_data .= 'body #header.sticky-header .nav a { font-size: 90%; }';
    }
}

if ($evolve_header_image_src) {
$evolve_css_data .= '.header-bg { background: url(' . esc_url($evolve_header_image_src) . ') ' . $evolve_background_position . ' ' . $evolve_background_repeat . '; border-bottom: 0; background-size: ' . $evolve_header_image . '; width: 100%; height:100%; position: absolute; opacity: '. $evolve_header_background_opacity .'; }';
    }
...
if ((is_home() || is_front_page()) && $evolve_frontpage_layout == "1c" && $evolve_frontpage_width_layout == "fluid") {
    $evolve_css_data .= '.content .container { width: 100%; padding-left: 0px; padding-right: 0px; } @media (min-width: ' . $evolve_min_width_px . 'px) { .content .container .t4p-fullwidth .t4p-row { width: ' . $evolve_min_width_100_px . 'px; margin-left: auto; margin-right: auto; } .t4p-fullwidth.homepage-content .t4p-row .t4p-row { width: 100%; } .contact-page { padding-left: 0px; padding-right: 0px; } .content .homepage-content { padding-top: ' . $evolve_content_top_padding .'; padding-bottom: ' . $evolve_content_bottom_padding .'; } .content { padding-top: 0px; padding-bottom: 0px; } }';
} else {
    $evolve_css_data .= '.content { padding-top: ' . $evolve_content_top_padding .'; padding-bottom: ' . $evolve_content_bottom_padding .'; } .page-template-contact-php #content { padding-top: ' . $evolve_content_top_padding .'; }';
}

if ( is_page_template('100-width.php') ) {
        $evolve_css_data .= '[class*="col-"] { padding-right: 0px; padding-left: 0px; } .row { margin-right: 0px; margin-left: 0px; }';
}
...
if ( $evolve_width_px != 'custom' ) {
    $evl_width_px = $evolve_min_width_px;
} else {
    $evl_width_px = $evolve_min_custom_width_px;
}

$evolve_css_data .= '@media (min-width: 767px) and (max-width: '.$evl_width_px.'px) { body.admin-bar #header.sticky-header{ width: 100%; margin-left:0; } }';