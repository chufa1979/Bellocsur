...
<div id="content" class="portfolio-template portfolio portfolio-one <?php echo $content_class; ?>" style="<?php echo $content_css; ?>">
    ...
    if (!post_password_required($post->ID)):
        if (is_array($portfolio_taxs) && !empty($portfolio_taxs) && get_post_meta($post->ID, 'evolve_portfolio_filters', true) != 'no'):
            ?>
            ...
            while ($gallery->have_posts()): $gallery->the_post();
                ...
                if (has_post_thumbnail() || get_post_meta($post->ID, 'evolve_video', true)):
                    ...
                    <div class="portfolio-item <?php echo $item_classes; ?>">
                        ...
                        <?php elseif (!has_post_thumbnail() && get_post_meta($post->ID, 'evolve_video', true)): ?>
                        ...
                        <div class="portfolio-content clearfix">
                            ...
                            <div class="buttons">
                                ...
                                <?php if (get_post_meta($post->ID, 'evolve_project_url', true)): ?>
                                    <a href="<?php echo get_post_meta($post->ID, 'evolve_project_url', true); ?>" class="<?php echo sprintf('read-more btn btn-default button medium t4p-button button-medium button-default button-%s button-%s', strtolower($evl_options['evl_shortcode_button_shape']), strtolower($evl_options['evl_shortcode_button_type'])); ?>"><?php echo __('View Project', 'evolve'); ?></a>            
                                <?php endif; ?>
                            </div>
                        </div>
