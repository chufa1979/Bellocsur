    ...
    <body <?php body_class(); ?>>
        ...
        if ($evolve_custom_background == "1") {
                ...
                if ( is_home() || is_front_page() ) {
                        if ( is_home() && !is_front_page() ) {
                            if ( ($evolve_current_post_slider_position == 'above') || ($evolve_current_post_slider_position == 'default' && $evolve_slider_position == 'above') ) {
                                ...
                                if ( is_front_page() && ( get_post_meta($evolve_page_ID, 'evolve_slider_type', true) == 'layer' || get_post_meta($evolve_page_ID, 'evolve_slider_type', true) == 'rev' || get_post_meta($evolve_page_ID, 'evolve_slider_type', true) == 'flex' ) ) {
                                    get_template_part('allslider_other');
                                }
            ...
            <div class="menu-container">
                ...
                if ( is_home() || is_front_page() ) {
                        if ($evolve_frontpage_width_layout == "fluid" && $evolve_menu_background == "1" || is_page_template('100-width.php')) {
                            echo '<div class="fluid-width">';
                        }
                } elseif ($evolve_width_layout == "fluid" && $evolve_menu_background == "1" || is_page_template('100-width.php')) {
                        echo '<div class="fluid-width">';
                }
                ?>
                    <div class="menu-back">
