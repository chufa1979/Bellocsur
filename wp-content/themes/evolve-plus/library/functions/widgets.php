<?php
get_template_part('library/functions/widgets/tweets-widget');
get_template_part('library/functions/widgets/flickr-widget');
get_template_part('library/functions/widgets/facebook-like-widget');
get_template_part('library/functions/widgets/125_125');
get_template_part('library/functions/widgets/social_links');
get_template_part('library/functions/widgets/contact_info');
get_template_part('library/functions/widgets/recent-works-widget');
