...
class Facebook_Like_Widget extends WP_Widget {
    ...
    function __construct() {
        parent::__construct(
                'facebook-like-widget', __('evolve: Facebook Like Box', 'evolve'), // Name
                array('classname' => 'facebook-like', 'description' => __('Adds support for Facebook Like Box.', 'evolve'),) // Args
        );
    }
