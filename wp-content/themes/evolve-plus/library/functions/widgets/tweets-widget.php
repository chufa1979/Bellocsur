...
class Tweets_Widget extends WP_Widget {
    ...
    function __construct() {
        parent::__construct(
                'tweets-widget', __('evolve: Twitter', 'evolve'), // Name
    ...
    function ago($time) {
        $periods = array(__('second', 'evolve'), __('minute', 'evolve'), __('hour', 'evolve'), __('day', 'evolve'), __('week', 'evolve'), __('month', 'evolve'), __('year', 'evolve'), __('decade', 'evolve'));
        $periods_plural = array(__('seconds', 'evolve'), __('minutes', 'evolve'), __('hours', 'evolve'), __('days', 'evolve'), __('weeks', 'evolve'), __('months', 'evolve'), __('years', 'evolve'), __('decades', 'evolve'));
