...
function flickr_load_widgets() {
    register_widget('evolve_Flickr_Widget');
}

class evolve_Flickr_Widget extends WP_Widget {

    function __construct() {
        parent::__construct(
                'flickr-widget', __('evolve: Flickr', 'evolve'), // Name
                array('classname' => 'flickr', 'description' => __('The most recent photos from flickr.', 'evolve'),) // Args		
        );
    }
