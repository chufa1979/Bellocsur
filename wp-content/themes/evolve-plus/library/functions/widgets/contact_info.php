...
class evolve_Contact_Info_Widget extends WP_Widget {
    ...
    function __construct() {
        parent::__construct(
                'contact_info-widget', __('evolve: Get In Touch', 'evolve'), // Name
    ...
    function widget($args, $instance) {
        ...
        if (isset($instance['email']) && $instance['email']):
            ?>
            <p class="email"><strong><i class="t4p-icon-envelope-o"></i>&nbsp;&nbsp;<?php _e('Email:', 'evolve'); ?></strong> <a href="mailto:<?php echo antispambot($instance['email']); ?>"><?php
                ...
                if (isset($instance['web']) && $instance['web']):
                    ?>
            <p class="web"><strong><i class="t4p-icon-web"></i>&nbsp;&nbsp;<?php _e('Web:', 'evolve'); ?></strong> <a href="<?php echo $instance['web']; ?>"><?php
                    if ($instance['webtxt']) {
