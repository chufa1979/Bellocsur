...
// Create link for convert elements
$convertshortcode = esc_url( admin_url( 'admin-ajax.php?action=evolve_convert_shortcode_' . $evolve_opt_name ) );
...
function evolve_migrate_options() {
    ...
    // Convert old slides to new repeater grouped slides.  :)
    $data = get_option($evolve_opt_name, false);
    $hasSlides = false;

    if (!isset($data['bootstrap_slides']) || ( isset($data['bootstrap_slides']) && empty($data['bootstrap_slides']) )) {
        $hasSlides = true;
        for ($i = 1; $i <= 5; $i ++) {
            $data['bootstrap_slides']['redux_repeater_data'][( $i - 1 )] = array(
                'title' => ''
            );

            if (isset($data["{$evolve_shortname}_bootstrap_slide{$i}"])) {
                if (!isset($data['bootstrap_slides']['enabled'])) {
                    $data['bootstrap_slides']['enabled'] = array();
                }
                $data['bootstrap_slides']['enabled'][( $i - 1 )] = $data["{$evolve_shortname}_bootstrap_slide{$i}"];
                //unset($data["{$evolve_shortname}_bootstrap_slide{$i}"]);
            }
            if (isset($data["{$evolve_shortname}_bootstrap_slide{$i}_img"])) {
                if (!isset($data['bootstrap_slides']['image'])) {
                    $data['bootstrap_slides']['image'] = array();
                }
                $data['bootstrap_slides']['image'][( $i - 1 )] = $data["{$evolve_shortname}_bootstrap_slide{$i}_img"];
                //unset($data["{$evolve_shortname}_bootstrap_slide{$i}_title"]);
            }

            if (isset($data["{$evolve_shortname}_bootstrap_slide{$i}_title"])) {
                if (!isset($data['bootstrap_slides']['title'])) {
                    $data['bootstrap_slides']['title'] = array();
                }
                $data['bootstrap_slides']['title'][( $i - 1 )] = $data["{$evolve_shortname}_bootstrap_slide{$i}_title"];
                //unset($data["{$evolve_shortname}_bootstrap_slide{$i}_title"]);
            }
            if (isset($data["{$evolve_shortname}_bootstrap_slide{$i}_desc"])) {
                if (!isset($data['bootstrap_slides']['description'])) {
                    $data['bootstrap_slides']['description'] = array();
                }
                $data['bootstrap_slides']['description'][( $i - 1 )] = $data["{$evolve_shortname}_bootstrap_slide{$i}_desc"];
                //unset($data["{$evolve_shortname}_bootstrap_slide{$i}_title"]);
            }
            if (isset($data["{$evolve_shortname}_bootstrap_slide{$i}_button"])) {
                if (!isset($data['bootstrap_slides']['button'])) {
                    $data['bootstrap_slides']['button'] = array();
                }
                $data['bootstrap_slides']['button'][( $i - 1 )] = $data["{$evolve_shortname}_bootstrap_slide{$i}_button"];
                //unset($data["{$evolve_shortname}_bootstrap_slide{$i}_button"]);
            }
        }
    }

    if (!isset($data['parallax_slides']) || ( isset($data['parallax_slides']) && empty($data['parallax_slides']) )) {
        $hasSlides = true;
        for ($i = 1; $i <= 5; $i ++) {
            $data['parallax_slides']['redux_repeater_data'][( $i - 1 )] = array(
                'title' => ''
            );
            if (isset($data["evl_show_slide{$i}"])) {
                if (!isset($data['parallax_slides']['enabled'])) {
                    $data['parallax_slides']['enabled'] = array();
                }
                $data['parallax_slides']['enabled'][( $i - 1 )] = $data["evl_show_slide{$i}"];
                //unset($data["evl_show_slide{$i}"]);
            }
            if (isset($data["evl_slide{$i}_img"])) {
                if (!isset($data['parallax_slides']['image'])) {
                    $data['parallax_slides']['image'] = array();
                }
                $data['parallax_slides']['image'][( $i - 1 )] = $data["evl_slide{$i}_img"];
                //unset($data["evl_slide{$i}_img"]);
            }
            if (isset($data["evl_slide{$i}_title"])) {
                if (!isset($data['parallax_slides']['title'])) {
                    $data['parallax_slides']['title'] = array();
                }
                $data['parallax_slides']['title'][( $i - 1 )] = $data["evl_slide{$i}_title"];
                //unset($data["evl_slide{$i}_title"]);
            }
            if (isset($data["evl_slide{$i}_desc"])) {
                if (!isset($data['parallax_slides']['description'])) {
                    $data['parallax_slides']['description'] = array();
                }
                $data['parallax_slides']['description'][( $i - 1 )] = $data["evl_slide{$i}_desc"];
                //unset($data["evl_slide{$i}_desc"]);
            }
            if (isset($data["evl_slide{$i}_button"])) {
                if (!isset($data['parallax_slides']['button'])) {
                    $data['parallax_slides']['button'] = array();
                }
                $data['parallax_slides']['button'][( $i - 1 )] = $data["evl_slide{$i}_button"];
                //unset($data["evl_slide{$i}_button"]);
            }
        }
    }
    ...
    if ($hasSlides) {
        update_option($evolve_opt_name, $data);
    }
}
...
// Register custom sidebars options
...
function evolve_colorpalettes() {
    ...
    wp_localize_script( 'evolve-colorpalettes', 'evolveajax', array( 'ajaxurl' => admin_url( 'admin-ajax.php' ) ) );
}
...
Redux::setArgs($evolve_opt_name, array(
    ...
    'display_name' => '<img width="128" height="34" src="' . get_template_directory_uri() . '/assets/images/functions/logo.jpg" alt="evolve">',
...
Redux::setSection($evolve_opt_name, array(
    ...
    'fields' => array(
        ...
        array(
            'id' => 'evl-front-page-elements-start',
            'type' => 'section',
        ...
        array(
            'id' => 'evl-front-page-elements-end',
            'type' => 'section',
            'indent' => false
        ),
        array(
        ...
        // Settings of import pagebuilder element in pages as shortcode
        array(
            ...
            'indent' => true
                ...
                array(
                    ...
                    'content' => __('<a class="button button-primary convertsc">Convert and Edit with Theme4Press Composer</a><div class="ajax_spinner"></div><div class="status_msg"></div>', "evolve"),
                    'full_width' => false,
                ),
        array(
...
// Front Page Content Boxes Section
Redux::setSection($evolve_opt_name, array(
    ...
    'fields' => array(
        ...
        // Content Boxes Section Setting
        array(
            'id'        => 'evl-front-page-content-boxes-setting-start',
            'type'      => 'accordion',
        ...
        array(
            'id'        => 'evl-front-page-content-boxes-setting-end',
            'type'      => 'accordion',
            'position'  => 'end'
        ),
...
Redux::setSection($evolve_opt_name, array(
    ...
    'fields' => array(
        ...
        array(
            'id' => 'evl-fp-blog-general-end',
            'type' => 'accordion',
            'position'  => 'end',
        ),
        // Section setting
        array(
            'id' => 'evl-fp-blog-section-start',
            'type' => 'accordion',
            'title' => 'Section Settings',
            'position'  => 'start',
        ),
...
// Dynamic section generation for testimonial slider
$slide_defaults = array(
    array(
        'image' => array('url' => "{$evolve_imagepathfolder}frontpage-builder/team-1.jpg"),
    ...
    array(
        'image' => array('url' => "{$evolve_imagepathfolder}frontpage-builder/team-2.jpg"),
...
Redux::setSection($evolve_opt_name, array(
    ...
    'fields' => array(
        ...
        array(
            ...
            'position'  => 'start',
                ...
                array(
                    ...
                    'subtitle' => '',
                    'desc' => '',
                    'default' => $slide_defaults,
                    'active' => false,
                    'group_values' => true,
                    'item_name' => __('Testimonial', 'evolve'),
                    'bind_title' => 'title',
                    'fields' => array(
                        array(
                            "title" => __('Enable Slide', 'evolve'),
                            "subtitle" => __('Enable or Disable Slide', 'evolve'),
                            "id" => "enabled",
                            "type" => "switch",
                            "default" => "1"
                        ),
                        array(
                            "title" => __('Testimonial Avatar', 'evolve'),
                            "subtitle" => __('Upload an image for the Testimonial, or specify an image URL directly', 'evolve'),
                            "id" => "image",
                            "type" => "media",
                            'url' => true,
                            'readonly' => false,
                        ...
                        array(
                            "title" => __('Testimonial Name', 'evolve'),
                            "id" => "title",
                            "type" => "text",
                            'class' => 'large-text'
                        ),
                        array(
                            "title" => __('Testimonial Content', 'evolve'),
                            "id" => "description",
                            "type" => "textarea",
                            "rows" => 5,
                        ),
        ...
        array(
            'id'        => 'evl-front-page-testimonial-setting-start',
            'type'      => 'accordion',
            'title'     => 'Section Settings',
            'position'  => 'start',
        ),
        ...
        array(
            'id'        => 'evl-front-page-testimonial-setting-end',
            'type'      => 'accordion',
            'position'  => 'end'
        ),
...
// Front Page Counter Circle Section

// Dynamic section generation for counter circle slider
$slide_defaults = array(
    array(
        'percentage' => '55',
        'title' => __(' android', 'evolve'),
    ),
    array(
        'percentage' => '75',
        'title' => __('  apple', 'evolve'),
    ),
    array(
        'percentage' => '88',
        'title' => __('  amazon', 'evolve'),
    ),
);

Redux::setSection($evolve_opt_name, array(
    'id' => 'evl-front-page-countercircle-tab',
    'title' => __('Counter Circle', 'evolve'),
    'subsection' => true,
    'fields' => array(
        // Add Counter Circle
        array(
            'id'       => 'evl-fp-cc-slides-start',
            'type'     => 'accordion',
            'title'    => 'Add Counter Circle',
            'position'  => 'start',
        ),
                array(
                    'id' => 'countercircle_slides',
                    'type' => 'repeater',
                    'title' => '',
                    'full_width' => true,
                    'subtitle' => '',
                    ...
                    'active' => false,
                    'group_values' => true,
                    'item_name' => __('Counter Circle', 'evolve'),
                    'bind_title' => 'title',
                    'fields' => array(
                        array(
                            "title" => __('Enable Slide', 'evolve'),
                        ...
                        array(
                            "title" => __('Counter Circle Icon', 'evolve'),
                        ...
                        array(
                            "title" => __('Counter Circle Percentage', 'evolve'),
                            "subtitle" => __('From 1% to 100%', 'evolve'),
                            "id" => "percentage",
                            "type" => "text",
                        ),
                        array(
                            "title" => __('Counter Circle Text', 'evolve'),
        ...
        array(
            'id'        => 'evl-fp-cc-slides-end',
            'type'      => 'accordion',
            'position'  => 'end'
        ),
        // Counter Circle Section Setting
        array(
            'id' => 'evl-fp-cc-section-start',
            'type' => 'accordion',
            'title' => 'Section Settings',
            'position'  => 'start',
        ),
...
Redux::setSection($evolve_opt_name, array(
    ...
    'subsection' => true,
    'fields' => array(
        //Add General Field Of Google Map
        array(
            'id'        => 'evl-fp-gmap-general-start',
            'type'      => 'accordion',
            'title'     => 'General',
            'position'  => 'start',
        ),
        ...
        array(
            'id'        => 'evl-fp-gmap-general-end',
            'type'      => 'accordion',
            'position'  => 'end'
        ),
        // Section settings
        array(
            'id' => 'evl-fp-gmap-section-start',
            'type' => 'accordion',
            'title' => 'Section Settings',
            'position' => 'start'
        ),
...
if (is_plugin_active('woocommerce/woocommerce.php')) :
    Redux::setSection($evolve_opt_name, array(
        ...
        'fields' => array(
            ...
            array(
                'id' => 'evl-fp-woo-product-end',
                'type' => 'accordion',
                'position' => 'end'
            ),
            // Section settings
            array(
                'id' => 'evl-fp-woo-product-section-start',
                'type' => 'accordion',
                'title' => 'Section Settings',
                'position' => 'start'
            ),
            ...
            array(
                'id' => 'evl-fp-woo-product-section-end',
                'type' => 'accordian',
                'position' => 'end'
            ),
        ),
...
Redux::setSection($evolve_opt_name, array(
    ...
    'fields' => array(
        ...
        array(
            'id' => 'evl-fp-custom-end',
            'type' => 'accordion',
            'position' => 'end'
        ),
        // Section settings
        array(
            'id' => 'evl-fp-custom-section-start',
            'type' => 'accordion',
            'title' => 'Section Settings',
            'position' => 'start'
        ),
...
Redux::setSection($evolve_opt_name, array(
    ...
    'fields' => array(
        ...
        array(
            ...
            'type' => "text",
            'required' => array(array("evl_width_px", '=', 'custom')),
            'default' => '',
        ),
        array(
        ...
        array(
            'subtitle' => sprintf(__('<span class="description">These options apply for the following layouts</span> <img style="float:left, display:inline" src="%s2cl.png" /> <img style="float:left, display:inline" src="%s2cr.png" />', 'evolve'), $evolve_imagepath, $evolve_imagepath),
        ...
        array(
            'subtitle' => sprintf(__('<span class="description">These options apply for the following layouts</span> <img style="float:left, display:inline" src="%s3cm.png" /> <img style="float:left, display:inline" src="%s3cr.png" /> <img style="float:left, display:inline" src="%s3cl.png" />', 'evolve'), $evolve_imagepath, $evolve_imagepath, $evolve_imagepath),
...
Redux::setSection($evolve_opt_name, array(
    ...
    'fields' => array(
        ...
        array(
            'subtitle' => __('Select the main menu hover effect. Smooth effect works only for Header #1 and #6', 'evolve'),
            'id' => 'evl_main_menu_hover_effect',
            'type' => 'select',
            'options' => array(
                'smooth' => __('Smooth', 'evolve'),
...
Redux::setSection($evolve_opt_name, array(
    ...
    'fields' => array(
        ...
        array(
            ...
            'required' => array(
                array('evl_pagetitlebar_layout', '=', '1')
            ),
...
// Dynamic section generation for bootstrap slider
$slide_defaults = array(
    array(
        'image' => array('url' => "{$evolve_imagepathfolder}bootstrap-slider/1.jpg"),
        'title' => __('Slide 1', 'evolve'),
    ...
    array(
        'image' => array('url' => "{$evolve_imagepathfolder}bootstrap-slider/2.jpg"),
        'title' => __('Slide 2', 'evolve'),
        'description' => __('Built-in Bootstrap Elements and Font Awesome let you do amazing things with your website', 'evolve'),
    ),
    array(
        'image' => array('url' => "{$evolve_imagepathfolder}bootstrap-slider/3.jpg"),
        'title' => __('Slide 3', 'evolve'),
        'description' => __('Select of 500+ Google Fonts, choose layout as you need, set up your social links', 'evolve'),
    ),
    array(
        'image' => array('url' => "{$evolve_imagepathfolder}bootstrap-slider/4.jpg"),
        'title' => __('Slide 4', 'evolve'),
        'description' => __('Adaptive to any screen depending on the device being used to view the site', 'evolve'),
    ),
    array(
        'image' => array('url' => "{$evolve_imagepathfolder}bootstrap-slider/5.jpg"),
        'title' => __('Slide 5', 'evolve'),
    ...
    'fields' => array(
        array(
            ...
            'fields' => array(
                ...
                array(
                    "title" => __('Image', 'evolve'),
                    "subtitle" => __('Upload an image for the Slide, or specify an image URL directly', 'evolve'),
                    "id" => "image",
                    "type" => "media",
                    'url' => true,
                    'readonly' => false,
...
// Dynamic section generation for parallax slider
$slide_defaults = array(
    array(
        'image' => array('url' => "{$evolve_imagepathfolder}parallax/6.png"),
        'title' => __('Super Awesome WP Theme', 'evolve'),
        'description' => __('Absolutely free of cost theme with amazing design and premium features which will impress your visitors', 'evolve'),
    ),
    array(
        'image' => array('url' => "{$evolve_imagepathfolder}parallax/5.png"),
        'title' => __('Bootstrap and Font Awesome Ready', 'evolve'),
        'description' => __('Built-in Bootstrap Elements and Font Awesome let you do amazing things with your website', 'evolve'),
    ),
    array(
        'image' => array('url' => "{$evolve_imagepathfolder}parallax/4.png"),
        'title' => __('Easy to use control panel', 'evolve'),
        'description' => __('Select of 500+ Google Fonts, choose layout as you need, set up your social links', 'evolve'),
    ),
    array(
        'image' => array('url' => "{$evolve_imagepathfolder}parallax/1.png"),
        'title' => __('Fully responsive theme', 'evolve'),
        'description' => __('Adaptive to any screen depending on the device being used to view the site', 'evolve'),
    ),
    array(
        'image' => array('url' => "{$evolve_imagepathfolder}parallax/3.png"),
...
function evolve_extend_customizer() {
    ...
    if (!class_exists('Redux_Customizer_Control_repeater')) {

        class Redux_Customizer_Control_repeater extends Redux_Customizer_Control {

            public $type = "redux-repeater";
...
if (!function_exists('evolve_redux_header_html')) {
    ...
    function evolve_redux_header_html() {
        ...
        <a href="<?php echo $url ?>" target="_blank">
            <img style="margin-bottom:20px;float:left;position:relative;top:10px;" width="827" height="133" border="0" alt="evolve - Multipurpose WordPress Theme" src="<?php echo get_template_directory_uri(); ?>/assets/images/functions/evolve.jpg">
        </a>
        <a href="http://wordpress.org/themes/evolve" target="_blank">
            <img style="margin:20px 0;clear:left;float:left;" width="645" height="27" border="0" alt="evolve on wordpress" src="<?php echo get_template_directory_uri(); ?>/assets/images/functions/rate.png">
        </a>
...
function evolve_import_demo_content($wp_customize) {
        ...
        if ( $frontpage_prebuilt_new_demo != $frontpage_prebuilt_old_demo ) {
                ...
                switch($frontpage_prebuilt_new_demo) {
                    case 'default':
                            $theme_options_txt = get_template_directory_uri() . '/library/plugins/importer/data/default.json';
                            break;
                    case 'blog':
                            $theme_options_txt = get_template_directory_uri() . '/library/plugins/importer/data/blog.json';
                            break;
                    case 'woocommerce':
                            $theme_options_txt = get_template_directory_uri() . '/library/plugins/importer/data/woocommerce.json';
                            break;
                    case 'blog-2':
                            $theme_options_txt = get_template_directory_uri() . '/library/plugins/importer/data/blog_2.json';
                            break;
                    case 'corporate':
                            $theme_options_txt = get_template_directory_uri() . '/library/plugins/importer/data/corporate.json';
                            break;
                    case 'magazine':
                            $theme_options_txt = get_template_directory_uri() . '/library/plugins/importer/data/magazine.json';
                            break;
                    case 'business':
                            $theme_options_txt = get_template_directory_uri() . '/library/plugins/importer/data/business.json';
                            break;
                    case 'woocommerce-2':
                            $theme_options_txt = get_template_directory_uri() . '/library/plugins/importer/data/woocommerce_2.json';
                            break;
                    case 'bbpress-buddypress':
                            $theme_options_txt = get_template_directory_uri() . '/library/plugins/importer/data/bbpress_buddypress.json';
                            break;
                }
...
if ( get_option('old_new_upgrade_themeoptions', 'false') == 'false' ) {
        ...
        $evl_slider_position = isset($evl_options['evl_slider_position']) ? $evl_options['evl_slider_position'] : 'below';
        $evolve_current_post_slider_position = 'default';
        if ( isset($postspage_id) && $postspage_id ) {
        ...
        if ( ($is_homepage == 'posts' && $evl_slider_position == 'below') || ( $is_homepage == 'page' && ( $evolve_current_post_slider_position == 'below' || ( $evolve_current_post_slider_position == 'default' && $evl_slider_position == 'below' ) ) ) ) {
        ...
        if ( ($is_homepage == 'posts' && $evl_slider_position == 'above') || ( $is_homepage == 'page' && ( $evolve_current_post_slider_position == 'above' || ( $evolve_current_post_slider_position == 'default' && $evl_slider_position == 'above' ) ) ) ) {
                if ( $evl_bootstrap_slider == 'homepage' && $evl_parallax_slider != 'homepage' && $evl_posts_slider != 'homepage' ) {
                $evl_options['evl_front_elements_header_area'] = array(
                                                                            'enabled' => array(
                                                                                'placebo' => 'placebo',
...
/* 
 * 
 * When switch theme evolve lite to evolve plus
 * convert bootstrap slider theme options
 * convert parallax slider theme options
 * 
 */
if ( get_option('evolvelite_theme', 'false') == 'true' ) {
        $bootstrap_slides = array();
        ...
        for ($a = 0; $a < 5; $a++) {
            ...
            //convert bootstrap slider theme options
            if ($evl_options["evl_bootstrap_slide{$n}"] == 1) {
                $bootstrap_slides['redux_repeater_data'][$a] = array('title' => '');
                $bootstrap_slides['enabled'][$a] = 1;
                $bootstrap_slides['image'][$a] = array(
                    'url' => esc_attr($evl_options["evl_bootstrap_slide{$n}_img"]['url']),
                    'id' => esc_attr($evl_options["evl_bootstrap_slide{$n}_img"]['id']),
                    'height' => esc_attr($evl_options["evl_bootstrap_slide{$n}_img"]['height']),
                    'width' => esc_attr($evl_options["evl_bootstrap_slide{$n}_img"]['width']),
                    'thumbnail' => esc_attr($evl_options["evl_bootstrap_slide{$n}_img"]['thumbnail']),
                );
                $bootstrap_slides['title'][$a] = esc_attr($evl_options["evl_bootstrap_slide{$n}_title"]);
                $bootstrap_slides['description'][$a] = esc_attr($evl_options["evl_bootstrap_slide{$n}_desc"]);
                $bootstrap_slides['button'][$a] = html_entity_decode ( esc_attr($evl_options["evl_bootstrap_slide{$n}_button"]) ); 
            }

            //convert parallax slider theme options
            if ($evl_options["evl_show_slide{$n}"] == 1) {
                $parallax_slides['redux_repeater_data'][$a] = array('title' => '');
                $parallax_slides['enabled'][$a] = 1;
                $parallax_slides['image'][$a] = array(
                    'url' => esc_attr($evl_options["evl_slide{$n}_img"]['url']),
                    'id' => esc_attr($evl_options["evl_slide{$n}_img"]['id']),
                    'height' => esc_attr($evl_options["evl_slide{$n}_img"]['height']),
                    'width' => esc_attr($evl_options["evl_slide{$n}_img"]['width']),
                    'thumbnail' => esc_attr($evl_options["evl_slide{$n}_img"]['thumbnail']),
                );
                $parallax_slides['title'][$a] = esc_attr($evl_options["evl_slide{$n}_title"]);
                $parallax_slides['description'][$a] = esc_attr($evl_options["evl_slide{$n}_desc"]);
                $parallax_slides['button'][$a] = html_entity_decode ( esc_attr($evl_options["evl_slide{$n}_button"]) );
            }
        }

        $evl_options['bootstrap_slides'] = $bootstrap_slides;
        $evl_options['parallax_slides'] = $parallax_slides;
        update_option('evl_options', $evl_options);

        update_option('evolvelite_theme', 'false');
}
