...
if (!class_exists('ReduxFramework_import_button')) {
    ...
    class ReduxFramework_import_button extends ReduxFramework {
        ...
        public function render() {
            ...
            echo "<button class='button button-primary import_demo_content_button' href='" . admin_url('themes.php?page=evl_options_options') . "&import_data_content=true" . "'>" . __('Import Demo Content', 'evolve')."</button>";
        }
