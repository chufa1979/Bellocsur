                    ...
                    var accordian = el.find(".redux-repeater-accordion").accordion(
                            {
                                ...
                                beforeActivate: function (event, ui) {
                                    ...
                                    if (!redux.repeater[gid].forced_collapse) {
                                        ...
                                        currHeader.toggleClass(
                                                'ui-corner-all', isPanelSelected
                                                ).toggleClass(
                                                'accordion-header-active ui-state-active ui-corner-top', !isPanelSelected
                                ...
                                heightStyle: redux.repeater[gid].height_style,
                                icons: {
                                    "header": redux.repeater[gid].icons.closed,
                                    "activeHeader": redux.repeater[gid].icons.open
                                }
