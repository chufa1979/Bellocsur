...
var HeaderDefault = {
    ...
    headerValue: {
        ...
        'h2': [
            {fieldType: 'font-family', fieldName: 'evl_title_font', fieldValue: 'Lobster', isGoogle: true},
            {fieldType: 'font-family', fieldName: 'evl_menu_font', fieldValue: 'Cabin', isGoogle: true},
            {fieldType: 'font-family', fieldName: 'evl_tagline_font', fieldValue: 'Cabin', isGoogle: true},
            {fieldType: 'select', fieldName: 'evl_social_box_radius', fieldValue: 'disabled'},
            {fieldType: 'select', fieldName: 'evl_menu_text_transform', fieldValue: 'uppercase'},
            {fieldType: 'select', fieldName: 'evl_menu_submenu_font_icon', fieldValue: 'plus'},
            {fieldType: 'color', fieldName: 'evl_top_menu_hover_font_color', fieldValue: '#0bb697'},
            {fieldType: 'select', fieldName: 'evl_pos_logo', fieldValue: 'left'},
            {fieldType: 'select', fieldName: 'evl_tagline_pos', fieldValue: 'disable'},
            {fieldType: 'select', fieldName: 'evl_social_icons_size', fieldValue: 'large'},
            {fieldType: 'select', fieldName: 'evl_main_menu_hover_effect', fieldValue: 'disable'},
        ],
        'h3': [
            {fieldType: 'font-family', fieldName: 'evl_title_font', fieldValue: 'Lato', isGoogle: true},
            {fieldType: 'font-family', fieldName: 'evl_menu_font', fieldValue: 'Vollkorn', isGoogle: true},
            {fieldType: 'font-family', fieldName: 'evl_tagline_font', fieldValue: 'Vollkorn', isGoogle: true},
            {fieldType: 'select', fieldName: 'evl_social_box_radius', fieldValue: '25'},
            {fieldType: 'select', fieldName: 'evl_menu_text_transform', fieldValue: 'uppercase'},
            {fieldType: 'color', fieldName: 'evl_top_menu_hover_font_color', fieldValue: '#0bb697'},
            {fieldType: 'select', fieldName: 'evl_pos_logo', fieldValue: 'left'},
            {fieldType: 'select', fieldName: 'evl_tagline_pos', fieldValue: 'disable'},
            {fieldType: 'select', fieldName: 'evl_social_icons_size', fieldValue: 'large'},
            {fieldType: 'select', fieldName: 'evl_main_menu_hover_effect', fieldValue: 'smooth'},
        ],
        'h4': [
            {fieldType: 'font-family', fieldName: 'evl_title_font', fieldValue: 'Dancing Script', isGoogle: true},
            {fieldType: 'font-family', fieldName: 'evl_menu_font', fieldValue: 'Josefin Slab', isGoogle: true},
            {fieldType: 'font-family', fieldName: 'evl_tagline_font', fieldValue: 'Josefin Slab', isGoogle: true},
            {fieldType: 'select', fieldName: 'evl_social_box_radius', fieldValue: 'disabled'},
            {fieldType: 'select', fieldName: 'evl_menu_submenu_font_icon', fieldValue: 'regular'},
            {fieldType: 'color', fieldName: 'evl_top_menu_hover_font_color', fieldValue: '#0bb697'},
            {fieldType: 'select', fieldName: 'evl_pos_logo', fieldValue: 'center'},
            {fieldType: 'select', fieldName: 'evl_menu_text_transform', fieldValue: 'none'},
            {fieldType: 'select', fieldName: 'evl_tagline_pos', fieldValue: 'under'},
            {fieldType: 'select', fieldName: 'evl_social_icons_size', fieldValue: 'large'},
            {fieldType: 'select', fieldName: 'evl_main_menu_hover_effect', fieldValue: 'disable'},
        ...
        'h5': [
            {fieldType: 'font-family', fieldName: 'evl_title_font', fieldValue: 'Raleway', isGoogle: true},
            {fieldType: 'font-family', fieldName: 'evl_menu_font', fieldValue: 'Goudy Bookletter 1911', isGoogle: true},
            {fieldType: 'font-family', fieldName: 'evl_tagline_font', fieldValue: 'Goudy Bookletter 1911', isGoogle: true},
            {fieldType: 'select', fieldName: 'evl_social_box_radius', fieldValue: 'disabled'},
            {fieldType: 'select', fieldName: 'evl_menu_text_transform', fieldValue: 'uppercase'},
            {fieldType: 'select', fieldName: 'evl_menu_submenu_font_icon', fieldValue: 'plus'},
            {fieldType: 'select', fieldName: 'evl_pos_logo', fieldValue: 'center'},
            {fieldType: 'color', fieldName: 'evl_top_menu_hover_color', fieldValue: '#0bb697'},
            {fieldType: 'color', fieldName: 'evl_top_menu_hover_font_color', fieldValue: '#ffffff'},
            {fieldType: 'select', fieldName: 'evl_tagline_pos', fieldValue: 'under'},
            {fieldType: 'select', fieldName: 'evl_social_icons_size', fieldValue: 'small'},
            {fieldType: 'select', fieldName: 'evl_main_menu_hover_effect', fieldValue: 'smooth'},
