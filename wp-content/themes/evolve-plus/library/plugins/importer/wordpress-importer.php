    ...
    class WP_Import extends WP_Importer {
        ...
        function process_menu_item($item) {
            ...
            $args = array(
                ...
                'menu-item-t4p-megamenu-status' => $_menu_item_t4p_megamenu_status,
                'menu-item-t4p-megamenu-width' => $_menu_item_t4p_megamenu_width,
                'menu-item-t4p-megamenu-columns' => $_menu_item_t4p_megamenu_columns,
                'menu-item-t4p-megamenu-title' => $_menu_item_t4p_megamenu_title,
                'menu-item-t4p-megamenu-widgetarea' => $_menu_item_t4p_megamenu_widgetarea,
                'menu-item-t4p-megamenu-icon' => $_menu_item_t4p_megamenu_icon,
                'menu-item-t4p-megamenu-thumbnail' => $_menu_item_t4p_megamenu_thumbnail
            );

            $id = wp_update_nav_menu_item($menu_id, 0, $args);
            if ($id && !is_wp_error($id)){
                $this->processed_menu_items[intval($item['post_id'])] = (int) $id;
                update_post_meta( $id, '_menu_item_t4p_megamenu_status', $args['menu-item-t4p-megamenu-status']);
                update_post_meta( $id, '_menu_item_t4p_megamenu_width', $args['menu-item-t4p-megamenu-width']);
                update_post_meta( $id, '_menu_item_t4p_megamenu_columns', $args['menu-item-t4p-megamenu-columns']);
                update_post_meta( $id, '_menu_item_t4p_megamenu_title', $args['menu-item-t4p-megamenu-title']);
                update_post_meta( $id, '_menu_item_t4p_megamenu_widgetarea', $args['menu-item-t4p-megamenu-widgetarea']);
                update_post_meta( $id, '_menu_item_t4p_megamenu_icon', $args['menu-item-t4p-megamenu-icon']);
                update_post_meta( $id, '_menu_item_t4p_megamenu_thumbnail', $args['menu-item-t4p-megamenu-thumbnail']);
            }
        }
        ...
        // return different file size in some images
