...
class sidebar_generator {
    ...
    public static function edit_form() {
        ...
        <p><?php _e('Please select the sidebar you would like to display on this page. <strong>Note:</strong> You must first create the sidebar under <strong>Appearance > Sidebars</strong>.', 'evolve'); ?>
        </p>
        <ul>
            <?php
