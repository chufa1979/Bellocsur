                ...
                <?php if (($evolve_header_meta == "") || ($evolve_header_meta == "single_archive")) : ?>
                    ...
                    <div class="entry-meta entry-header">
                        ...
                        <span class="author vcard">
                            <?php _e('Written by', 'evolve'); ?> <strong><?php printf('<a class="url fn" href="' . get_author_posts_url($authordata->ID, $authordata->user_nicename) . '" title="' . sprintf('View all posts by %s', 'evolve', $authordata->display_name) . '">' . get_the_author() . '</a>') ?></strong>
                        </span>
                        <?php
        ...
        while ($wp_query->have_posts()) : $wp_query->the_post();
            ...
            <div id="post-<?php the_ID(); ?>" class="<?php semantic_entries(); ?> <?php evolve_post_class_2(); ?>">
                ...
                if (($evolve_header_meta == "") || ($evolve_header_meta == "single_archive")) {
                    ...
                    <div class="entry-meta entry-header">
                        ...
                        <span class="author vcard">
                            ...
                            ?> <strong><?php printf('<a class="url fn" href="' . get_author_posts_url($authordata->ID, $authordata->user_nicename) . '" title="' . sprintf('View all posts by %s', 'evolve', $authordata->display_name) . '">' . get_the_author() . '</a>') ?></strong>
                        </span>
                        <?php
                        if ($evolve_edit_post == "1") {
                            if (current_user_can('edit_post', $post->ID)):
                ...
                <div class="entry-content article">
                    ...
                    echo evolve_excerpt_max_charlength(700);
                    ?>
