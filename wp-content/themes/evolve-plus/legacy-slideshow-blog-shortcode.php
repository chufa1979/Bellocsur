...
if ($atts['layout'] != 'grid' && $atts['layout'] != 'timeline'):
    ...
    <?php if (get_post_meta($post->ID, 'evolve_fimg_width', true) && get_post_meta($post->ID, 'evolve_fimg_width', true) != 'auto'): ?>
            #post-<?php echo $post->ID; ?> .post-slideshow,
            #post-<?php echo $post->ID; ?> .floated-post-slideshow {
                max-width: <?php echo get_post_meta($post->ID, 'evolve_fimg_width', true); ?> !important;
            }
        <?php
    endif;

    if (get_post_meta($post->ID, 'evolve_fimg_height', true) && get_post_meta($post->ID, 'evolve_fimg_height', true) != 'auto'):
        ?>
            #post-<?php echo $post->ID; ?> .post-slideshow,
            #post-<?php echo $post->ID; ?> .floated-post-slideshow,
            ...
            #post-<?php echo $post->ID; ?> .floated-post-slideshow .image > a > img {
                height: <?php echo get_post_meta($post->ID, 'evolve_fimg_height', true); ?> !important;
            }
        <?php
    endif;

    if (get_post_meta($post->ID, 'evolve_fimg_width', true) && get_post_meta($post->ID, 'evolve_fimg_width', true) == 'auto'):
        ?>
            #post-<?php echo $post->ID; ?> .post-slideshow .image > img,
            #post-<?php echo $post->ID; ?> .floated-post-slideshow .image > img,
            #post-<?php echo $post->ID; ?> .post-slideshow .image > a > img,
...
if ($atts['layout'] == 'large' || $atts['layout'] == 'large alternate' || $atts['layout'] == 'grid' || $atts['layout'] == 'timeline'):
    ...
    if ($attachments || has_post_thumbnail() || get_post_meta(get_the_ID(), 'evolve_video', true)):
        ?>
