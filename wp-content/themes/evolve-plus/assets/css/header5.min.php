...
$evolve_css_data .= '@media only screen and (min-width:769px){.menu-container .menu-header{background:rgba(' . $header_pattern . ')!important;position:absolute;z-index:999;width:100%}}';
    }
...
$evolve_css_data .= 'ul.nav-menu li .slash{position:absolute;top:34%;left:-5px;color:'.$color.'!important}ul.nav-menu li:hover .slash{color:'.$color.'!important}';
}
...
$evolve_css_data .= '.link-effect .sub-menu a{white-space:normal}#wrapper .primary-menu .link-effect a{overflow:visible}.primary-menu a.sf-with-ul::before{color:#c1c1c1!important;content:"/";position:absolute;right:-13px;z-index:99999}';
}
...
$evolve_css_data .= '.ubermenu-nav .slash{display:none!important}@media only screen and (min-width:769px){.primary-menu .nav{display:block}}';
    }
}