...
@media only screen and (max-width: 768px) {
    ...
    #wrapper .woocommerce-menu-holder .dd-container{
        text-align: center;
    }
    #wrapper .woocommerce-menu-holder .dd-container .dd-options{
        margin-top: 8px;
    }
}
...
ul.nav-menu li li > a span,
ul.nav-menu li li li > a span,
ul.nav-menu li li li li > a span {
...
ul.nav-menu li.current-menu-ancestor > a span.menu-text,
.header_v3ul.nav-menu .sub-menu li.active a,
.sticky-header ul.nav-menu li.current-menu-item > a span,
.dropdown.nav-hover > .sf-with-ul > span,
.t4p-dropdown-menu.nav-hover > a{
    border-bottom: 2px solid ' . $evolve_top_menu_hover_font_color . ';
}


#wrapper ul.nav-menu li ul span {
	border-bottom:0;
}


ul.nav-menu li span, ul.nav-menu li.current-menu-item > a span,
ul.nav-menu li.current-menu-ancestor > a span.menu-text,
.header_v3ul.nav-menu .sub-menu li.active a,
.sticky-header ul.nav-menu li.current-menu-item > a span,
.t4p-dropdown-menu > a{
...
ul.nav-menu li.current-menu-ancestor .sub-menu a span {
    border-bottom: none;
}
/*
...
ul.nav-menu li > a .t4p-megamenu-icon {
    vertical-align: baseline;
    height: 0;
}
...
@media (max-width: ' . $breakpoint_actual . 'px) {
    ...
    .col-ubermenu a.ubermenu-responsive-toggle {
        text-align: center;
        margin-top: 5px;
    }
    .col-ubermenu .ubermenu a {
        text-align: left;
    }
    .col-ubermenu #search-text-box #search_label_top,
    .col-ubermenu .searchform,
    .col-ubermenu #search-text-box {
        float: none;
    }
    .col-ubermenu #tagline {
