                                ...
                                <div class="woocommerce-menu-holder">
                                    <ul class="woocommerce-menu">
                                        <?php if ($woocommerce_cart_link_main_nav): ?>
                                            ...
                                            <?php
                                        endif; //if($woocommerce_cart_link_main_nav):     
                        ...
                        <div class="primary-menu">
                            ...
                            if (has_nav_menu('primary-menu')) {
                                ...
                                if (evolve_get_option('evl_disable_megamenu', '0') == '0'):
                                    ...
                                    wp_nav_menu(array('theme_location' => 'primary-menu', 'menu_class' => 'nav-menu', 'after' => '<span class="slash">/</span>', 'walker' => new evolve_Walker_Nav_Menu()));
                                endif;
