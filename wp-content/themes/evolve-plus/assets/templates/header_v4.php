...
<div class="new-top-menu header_v3">
    <div class="container">
            ...
            <div class="header">
                <div class="container">
                    ...
                    <div class="container-header">
                        ...
                        <div class="title-container col-ubermenu logobar col-md-3 col-sm-3">
                            <?php
                        ...
                        <!--END .title-container-->
                        <div class="col-ubermenu headerbar col-md-7 col-sm-7">
