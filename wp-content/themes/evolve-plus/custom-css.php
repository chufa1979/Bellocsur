...
.t4p-counters-box .t4p-counter-box .counter-box-container { 
    color: ' . $evolve_shortcode_counter_boxes_color . ' ;
}
...
.t4p-flip-box .flip-box-heading {
    color: ' . $evolve_shortcode_flip_boxes_heading_color_frontside . ' ;
}

.t4p-flip-box .flip-box-heading-back {
    color: ' . $evolve_shortcode_flip_heading_color_backside . ' ;
}

.sep-boxed-pricing .panel-heading h3 {
    color: ' . $evolve_shortcode_pricing_style_1_heading_color . ' ;
}

.full-boxed-pricing.t4p-pricing-table .panel-heading h3 {
    color: ' . $evolve_shortcode_pricing_style_2_heading_color . ' ;
}
...
.full-boxed-pricing {
    border-color: ' . $evolve_shortcode_pricing_box_border_color . ' ;
}
...
.t4p-title .title-sep {
    border-color: ' . $evolve_shortcode_title_sep_color . ';
}
...
ul.nav-menu a {
    text-transform: ' . $evolve_menu_text_transform . '
}
...
if ( is_home() || is_front_page() ) {
    if ($evolve_width_px != "custom" && ( $evolve_frontpage_width_layout == "fixed" ) && !is_page_template('100-width.php')) {
        ...
        $evolve_css_data .= '
        @media (min-width: ' . $evolve_min_custom_width_px . 'px) {
            .container,
            #wrapper {
                width: ' . $evolve_custom_width_px . 'px;
            }
            .wooslider {
                max-width: ' . $evolve_custom_width_px . 'px;
            }
        }
        ';
    } elseif($evolve_width_px == "custom" ) {
...
$evolve_css_data .= ' 
@media only screen and (max-width: ' . $evolve_max_width_px . 'px) {
...
$evolve_css_data .= ' 
@media only screen and (max-width: ' . $evolve_max_custom_width_px . 'px) {
    body #header.sticky-header {
        margin: 0px ;
        left: 0px;
    }
...
@media (min-width: ' . $evolve_min_width_px . 'px) {
    ...
    .t4p_frontpage_blog.content .container {
...
@media (max-width: ' . $evolve_min_custom_width_px . 'px) {
    .container-100-width {
        width: auto;
        padding-left: 15px;
        padding-right: 15px;
...
@media (min-width: ' . $evolve_min_custom_width_px . 'px) {
    .container-100-width {
        width: ' . $evolve_min_custom_width_100_px_plus . 'px;
        padding-left: 15px;
        padding-right: 15px;
        margin-left: -' . $evolve_custom_left_100 . 'px;
        left: 50%;
        position: relative;
    }
}
...
@media (min-width: ' . $evolve_min_custom_width_px . 'px) {
    .content .container .t4p-fullwidth .t4p-row,
    .t4p_frontpage_blog.content .container {
        width: ' . $evolve_min_custom_width_100_px . 'px;
        margin-left: auto;
        margin-right: auto;
    }
}
...
@font-face {
    ...
    src: url("' . $evolve_custom_font_eot['url'] . '");
    src: url("' . $evolve_custom_font_eot['url'] . '?#iefix") format("eot"), url("' . $evolve_custom_font_woff['url'] . '") format("woff"), url("' . $evolve_custom_font_ttf['url'] . '") format("truetype"), url("' . $evolve_custom_font_svg['url'] . '#CustomFont") format("svg");
    font-weight: 400;
    font-style: normal;
}
...
body .t4p-person .person-desc .person-author .person-author-wrapper {
    font-family: "CustomFont";
}
...
';
    ...
    ul.nav-menu li.current_page_ancestor {
...
$evolve_css_data .= '
.page-title-container {
    background-image: url(' . $page_title_bar_bg . ');
}
';
elseif (isset($page_title_bg_opt)):
$evolve_css_data .= '
.page-title-container {
    background-image: url(' . $page_title_bg_opt . ');    
}
';
    endif;
...
@media (min-width: 992px) {
    .home-content-boxes .col-md-3.content-box {
        padding-top: '.$evolve_content_boxes_padding['padding-top'].';
        padding-right: '.$evolve_content_boxes_padding['padding-right'].';
        padding-bottom: '.$evolve_content_boxes_padding['padding-bottom'].';
        padding-left: '.$evolve_content_boxes_padding['padding-left'].';
    }
}
';
...
@media (min-width: ' . $evolve_min_width_px . 'px) {
    #wrapper .t4p-megamenu-wrapper.col-span-1 {
        width: ' . $evolve_width_col_span_1 . 'px;
    }
    #wrapper .t4p-megamenu-wrapper.col-span-2 {
        width: ' . $evolve_width_col_span_2 . 'px;
    }
    #wrapper .t4p-megamenu-wrapper.col-span-3 {
        width: ' . $evolve_width_col_span_3 . 'px;
    }
...
#wrapper .t4p-megamenu-wrapper .t4p-megamenu-title {
    font-family: '.$evolve_menu_font['font-family'].';
    font-size: '.$evolve_megamenu_title_size.';
...
.t4p-megamenu-bullet {
    border-left: 3px solid '.$evolve_menu_font['color'].';
}
...
ul.nav-menu .t4p-megamenu-menu .widget-content a {
    color: '.$evolve_widget_content_font['color'].' ;
}
...
$evolve_css_data .= '
.page-title-container {
        background-color: '.$evolve_page_title_bar_bg_color.';
}
';
...
$evolve_css_data .= '
.page-title-container {
    background-color: '.$evolve_pagetitlebar_background_color.';
}
';
endif;
...
$evolve_css_data .= '
    .page-title-container {
        background-image: url("'.$evolve_page_title_bar_bg_src['0'].'");
    }
';
...
$evolve_css_data .= '
.page-title-container {
    background-image: url("'.$evolve_pagetitlebar_background.'");
}
';
endif;
...
only screen and (min-resolution: 120dpi) {
    .page-title-container {
        background-image: url("'.$evolve_page_title_bar_bg_retina_src['0'].'");
    }
}
';
...
only screen and (min-resolution: 120dpi) {
    .page-title-container {
        background-image: url("'.$evolve_pagetitlebar_background_retina.'");
    }
}
';
endif;
...
$evolve_css_data .= '
.page-title-container {
    padding: '.$evolve_pagetitlebar_padding.'px 0px;
}
';
endif;
...
if (is_plugin_active('ubermenu/ubermenu.php')) {
    ...
    if ($evolve_ubermenu == '1') {
$evolve_css_data .= '
@media (min-width: ' . $breakpoint_expand . 'px) {
    .ubermenu-responsive-toggle {
        display: none ;
    }
}

@media (max-width: ' . $breakpoint_actual . 'px) {
    body #header.sticky-header.sticky {
        display: none ;
    }   
    ...
    .ubermenu li.menu-item-language {
        float: none;
    }
    .ubermenu li.menu-item-language ul.sub-menu {
        display: none;
    }
    .ubermenu li.menu-item-language ul.sub-menu {
        width: 100%;
    ...
    .ubermenu li.menu-item-language:hover ul.sub-menu {
        display: block;
    }
}
';
...
.header-bg{
    ...
    height:100%;
    position: absolute;
    opacity: '. $evolve_header_background_opacity .';
}
';
    }
...
$evolve_css_data .= '
@media (min-width: 767px) and (max-width: '.$evl_width_px.'px) {
